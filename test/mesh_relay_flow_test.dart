...
void main() {
  ...
  group(
    ...
    () {
      ...
      testWidgets(
        ...
        (WidgetTester tester) async {
          ...
          for (int i = 0; i < 15; i++) {
            // Exceed maxRelaysPerSenderPerHour (10)
            ...
            if (relay != null) {
              results.add(
                relayEngine.processIncomingRelay(
                  relayMessage: relay,
                  fromNodeId: nodeA,
        ...
        skip: true,
      ); // SKIP: Parallel processing causes deadlock in spam prevention
      ...
      testWidgets('Recipient Detection Optimization', (
        WidgetTester tester,
      ) async {
        await relayEngine.initialize(currentNodeId: nodeB);
      ...
      testWidgets('Integration with BLE Message Handler', (
        WidgetTester tester,
      ) async {
    ...
    skip:
        'TEMPORARILY SKIP: Multi-node tests need BLE mocking - will fix after simpler tests pass',
  );
}
