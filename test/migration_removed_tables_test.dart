...
void main() {
  ...
  group('Migration with Removed Tables Tests', () {
    test('Migration skips tables not in destination schema', () async {
      ...
      final newDbPath = join(
        databasesPath,
        'test_new_without_removed_table.db',
      );
      ...
      await oldDb.insert('user_preferences', {'key': 'theme', 'value': 'dark'});
      ...
      expect(
        sourceTables.length,
        equals(3),
      ); // contacts, chats, user_preferences
    ...
    test(
      'Migration handles database with only removed tables gracefully',
      () async {
