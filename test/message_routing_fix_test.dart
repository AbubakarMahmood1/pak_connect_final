...
void main() {
  group('Message Routing Fix Tests', () {
    ...
    test('Should allow legitimate direct messages between different users', () async {
      ...
      expect(result, equals('Hello Ali!'), 
        reason: 'Direct messages from other users should be processed');
    });
    
    test('Should block messages with intendedRecipient not matching current user', () async {
    ...
    test('Should allow messages with intendedRecipient matching current user', () async {
      ...
      // Should return the message content (allowed)
      expect(result, equals('Message specifically for Ali'), 
