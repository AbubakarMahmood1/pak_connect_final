/// OutboundMessageSender tests covering uncovered branches:
...
void main() {
 ...
 await sender.sendBinaryPayload(data: Uint8List.fromList(List.filled(200, 0xAA)),
 mtuSize: 60,
 originalType: 1,
 ...
 await sender.sendBinaryPayload(data: Uint8List.fromList([0x01]),
 mtuSize: 512,
 originalType: 0,
 ...
 final sender = makeSender();
 final sentChunks = <Uint8List>[];
 await sender.sendBinaryPayload(data: Uint8List.fromList(List.filled(300, 0xBB)),
 mtuSize: 60,
 originalType: 2,
 recipientId: 'r',
 sendChunk: (chunk) async => sentChunks.add(chunk),
 ...
 final sentChunks = <Uint8List>[];
 // 10KB payload
 await sender.sendBinaryPayload(data: Uint8List.fromList(List.filled(10240, 0xFF)),
 mtuSize: 128,
 originalType: 3,
