...
void main() {
 ...
 final msg = ProtocolMessage(type: ProtocolMessageType.contactRequest,
 ...
 final msg = ProtocolMessage.contactAccept(publicKey: 'pk_bob',
 displayName: 'Bob',
);
 ...
 handler.onCryptoVerificationResponseReceived((verifId,
 contactKey,
 isVerified,
 payload,
) {
 ...
 final result = await handler.processProtocolMessage(message: ProtocolMessage.ping(),
