/// OutboundMessageSender additional coverage tests focusing on:
...
void main() {
 ...
 return OutboundMessageSender(logger: logger,
 ...
 expect(() => sender.sendBinaryPayload(data: Uint8List.fromList([1, 2, 3]),
 mtuSize: 512,
 originalType: 1,
 ...
 try {
 await sender.sendBinaryPayload(data: Uint8List.fromList(List.filled(500, 0xAA)),
 mtuSize: 60,
 originalType: 1,
 ...
 try {
 await sender.sendBinaryPayload(data: Uint8List.fromList(List.filled(500, 0xBB)),
 mtuSize: 60,
 originalType: 1,
 sendChunk: (chunk) async {
 sendCount++;
 ...
 await sender.sendBinaryPayload(data: Uint8List.fromList([0x42]),
 mtuSize: 512,
 originalType: 0,
 ...
 final sender = makeSender();
 final chunks = <Uint8List>[];
 await sender.sendBinaryPayload(data: Uint8List.fromList(List.filled(50, 0xCC)),
 mtuSize: 200,
 originalType: 0,
 sendChunk: (chunk) async => chunks.add(chunk),
);
 ...
 final sender = makeSender();
 final chunks = <Uint8List>[];
 await sender.sendBinaryPayload(data: Uint8List.fromList([1, 2, 3, 4, 5]),
 mtuSize: 200,
 originalType: 1,
 ...
 await sender.sendBinaryPayload(data: Uint8List.fromList([1, 2, 3]),
 mtuSize: 512,
 originalType: 1,
 ...
 await sender.sendBinaryPayload(data: Uint8List.fromList(List.filled(2048, 0xDD)),
 mtuSize: 128,
 originalType: 1,
 recipientId: 'big',
 sendChunk: (chunk) async => chunks.add(chunk),
 ...
 final sender = makeSender();
 final chunks = <Uint8List>[];
 await sender.sendBinaryPayload(data: Uint8List.fromList(List.filled(200, 0xEE)),
 mtuSize: 60,
 originalType: 1,
 recipientId: 'magic',
 sendChunk: (chunk) async => chunks.add(chunk),
 ...
 final sender = makeSender();
 final chunks = <Uint8List>[];
 await sender.sendBinaryPayload(data: Uint8List.fromList(List.filled(200, 0xFF)),
 mtuSize: 60,
 originalType: 1,
 recipientId: 'fid',
 sendChunk: (chunk) async => chunks.add(chunk),
 ...
 await sender.sendBinaryPayload(data: Uint8List.fromList(List.filled(300, 0x11)),
 mtuSize: 60,
 originalType: 0,
 ...
 await sender.sendBinaryPayload(data: Uint8List.fromList([4, 5, 6]),
 mtuSize: 512,
 originalType: 2,
 recipientId: 'second',
