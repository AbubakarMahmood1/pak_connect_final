...
void main() {
  group('BLEStateManagerFacade', () {
    ...
    test('forwards callback properties and protocol-message bridges', () {
      ...
      facade.onDeviceDiscovered = (_, __) => deviceDiscovered++;
      facade.onMessageSent = (_, __) => messageSent++;
      facade.onMessageSentIds = (_, __) => messageSentIds++;
      ...
      facade.onContactRequestReceived = (_, __) => requestReceived++;
      facade.onContactRequestCompleted = (_) => requestCompleted++;
      facade.onSendContactRequest = (_, __) => sendContactRequest++;
      facade.onSendContactAccept = (_, __) => sendContactAccept++;
      facade.onSendContactReject = () => sendContactReject++;
      facade.onSendContactStatus = (_) => sendContactStatus++;
      facade.onAsymmetricContactDetected = (_, __) => asymmetricDetected++;
      facade.onMutualConsentRequired = (_, __) => mutualConsentRequired++;
