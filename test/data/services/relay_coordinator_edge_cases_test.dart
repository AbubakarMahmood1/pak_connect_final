/// RelayCoordinator tests covering uncovered branches:
...
class _ConfigurableRelayEngine implements domain_messaging.MeshRelayEngine {
 ...
 : stats =
 stats ??
 const RelayStatistics(totalRelayed: 5,
 totalDropped: 2,
...
void main() {
 ...
 final result = await coordinator.handleMeshRelay(originalMessageId: 'msg-self',
 content: 'Hello self',
 ...
 final result = await coordinator.handleMeshRelay(originalMessageId: 'broadcast-1',
 ...
 test('still invokes relay callback when intendedRecipient is another node',
 () async {
 ...
 final result = await coordinator.handleMeshRelay(originalMessageId: 'msg-other',
 content: 'msg for B',
 originalSender: 'sender',
 ...
 final result = await coordinator.handleMeshRelay(originalMessageId: 'high-hop',
 content: 'content',
 originalSender: 'sender',
 intendedRecipient: null,
 messageData: null,
 ...
 final result = await coordinator.handleMeshRelay(originalMessageId: 'dup-msg',
 content: 'duplicate',
 originalSender: 'sender',
 intendedRecipient: null,
 messageData: null,
 ...
 await coordinator.handleMeshRelay(originalMessageId: 'mark-test',
 content: 'msg',
 originalSender: 'sender',
 intendedRecipient: null,
 messageData: null,
 ...
 final result = await coordinator.handleMeshRelay(originalMessageId: 'null-hop',
 content: 'msg',
 originalSender: 'sender',
 intendedRecipient: null,
 messageData: null,
 ...
 await coordinator.handleMeshRelay(originalMessageId: 'ids-test',
 content: 'c',
 originalSender: 'sender',
 intendedRecipient: null,
 messageData: null,
 ...
 final result = await coordinator.handleMeshRelay(originalMessageId: 'short',
 content: 'c',
 originalSender: 'sender',
 intendedRecipient: null,
 messageData: null,
 ...
 final msg = await coordinator.createOutgoingRelay(originalMessageId: 'orig-1',
 content: 'payload',
 ...
 expect(msg!.relayMetadata.finalRecipient,
 ...
 final msg = await coordinator.createOutgoingRelay(originalMessageId: 'orig-2',
 content: 'data',
 originalSender: 'sender',
 ...
 final msg = await coordinator.createOutgoingRelay(originalMessageId: 'no-node',
 content: 'c',
 originalSender: 's',
 intendedRecipient: 'r',
 currentHopCount: 0,
 ...
 final relayMsg = MeshRelayMessage.createRelay(originalMessageId: 'r-msg-1',
 originalContent: 'hello',
 metadata: metadata,
 relayNodeId: 'relay-me',
);

 await coordinator.handleRelayToNextHop(relayMessage: relayMsg,
 ...
 final metadata = RelayMetadata.create(originalMessageContent: 'c',
 priority: MessagePriority.normal,
 originalSender: 's',
 finalRecipient: 'r',
 currentNodeId: 'node-1',
);
 final relayMsg = MeshRelayMessage.createRelay(originalMessageId: 'ack-timeout-msg',
 originalContent: 'c',
 metadata: metadata,
 relayNodeId: 'node-1',
);
 ...
 coordinator.handleRelayDeliveryToSelf(originalMessageId: 'dual-cb',
 content: 'c',
 originalSender: 'sender',
);
 ...
 coordinator.handleRelayDeliveryToSelf(originalMessageId: 'ack-me',
 content: 'c',
 ...
 expect(coordinator.shouldAttemptRelay(messageId: 'm', currentHopCount: 3),
 isFalse,
);
 });

 test('returns true at hop count 2', () {
 expect(coordinator.shouldAttemptRelay(messageId: 'm', currentHopCount: 2),
 isTrue,
);
 });
 ...
 expect(coordinator.shouldAttemptRelay(messageId: 'tiny', currentHopCount: 0),
 isFalse,
);
 });
 ...
 expect(coordinator.shouldAttemptRelay(messageId: 'any', currentHopCount: 0),
 isTrue,
);
 });
 });
 ...
 final result = await coordinator.shouldAttemptDecryption(messageId: 'x',
 senderKey: 'key',
);
 expect(result, isFalse);
 });
 ...
 await coordinator.sendRelayAck(originalMessageId: 'ack-target',
 toDeviceId: 'device',
 ...
 await coordinator.sendRelayAck(originalMessageId: 'no-cb',
 toDeviceId: 'device',
 ...
 final relayMsg = MeshRelayMessage.createRelay(originalMessageId: 'ack-cancel-test',
 originalContent: 'c',
 metadata: metadata,
 relayNodeId: 'node',
);
 ...
 await coordinator.handleRelayAck(originalMessageId: 'ack-cancel-test',
 fromDeviceId: 'hop',
 ...
 await coordinator.handleRelayAck(originalMessageId: 'nonexistent',
 fromDeviceId: 'device',
 ackData: null,
);
 // Should not throw
 ...
 final result = await coordinator.sendQueueSyncMessage(toNodeId: 'peer-node',
 messageIds: ['m1', 'm2'],
);
 expect(result, isTrue);
 });
 ...
 await coordinator.sendQueueSyncMessage(toNodeId: 'peer',
 messageIds: ['id1'],
);
 ...
 final result = await coordinator.sendQueueSyncMessage(toNodeId: 'peer',
 messageIds: ['id1'],
);
 expect(result, isTrue);
 });
 ...
 final syncMsg = QueueSyncMessage.createRequestWithIds(messageIds: [MessageId('id-1')],
 nodeId: 'peer',
);
 ...
 RelayCoordinator.configureDependencyResolvers(sharedQueueProviderResolver: () => queueProv,
 ...
 RelayCoordinator.configureDependencyResolvers(sharedQueueProviderResolver: () => _FakeSharedQueueProvider(),
 ...
 final coord = RelayCoordinator();
 expect(() => coord.initializeRelaySystem(currentNodeId: 'fail'),
 ...
 final coord = RelayCoordinator();
 expect(() => coord.initializeRelaySystem(currentNodeId: 'partial'),
 throwsA(isA<StateError>()),
);
 coord.dispose();
 });
 ...
 final coord = RelayCoordinator(sharedQueueProvider: queueProv,
 ...
 final coord = RelayCoordinator(relayEngineFactory: _FakeMeshRelayEngineFactory(),
);
 expect(() => coord.initializeRelaySystem(currentNodeId: 'no-queue'),
 throwsA(isA<StateError>()),
);
 coord.dispose();
 },
 ...
 expect(coordinator.shouldAttemptRelay(messageId: 'x', currentHopCount: 0),
 isTrue,
);
 ...
 final relayMsg = MeshRelayMessage.createRelay(originalMessageId: 'dispose-timer',
 originalContent: 'c',
 metadata: metadata,
 relayNodeId: 'n',
);
 ...
 final relayMsg = MeshRelayMessage.createRelay(originalMessageId: 'engine-relay',
 originalContent: 'c',
 metadata: metadata,
