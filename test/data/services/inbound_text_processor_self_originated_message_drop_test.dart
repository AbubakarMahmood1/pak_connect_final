...
void main() {
 ...
 processor = InboundTextProcessor(contactRepository: contactRepo,
 ...
 final result = await processor.process(protocolMessage: message,
 ...
 final notForMe = InboundTextProcessor(contactRepository: contactRepo,
 ...
 final result = await notForMe.process(protocolMessage: message,
 ...
 await processor.process(protocolMessage: message,
 senderPublicKey: 'sender',
 onMessageIdFound: (id) {
 capturedId = id;
 return null;
...
class _FakeSecurityService implements ISecurityService {
 ...
 @override
 Future<String> decryptMessage(String message,
 String senderKey,
 IContactRepository repo,
) async {
 _decryptCallCount++;
 ...
 @override
 Future<String> decryptMessageByType(String message,
 String senderKey,
 IContactRepository repo,
 EncryptionType type,
) async {
