// DatabaseMonitorService coverage
...
void main() {
 ...
 final m = TableMetrics(name: 'empty',
 rowCount: 0,
 sizeBytes: 0,
 unusedBytes: 0,
 fragmentationRatio: 0.0,
 ...
 final idx = IndexMetrics(name: 'idx_test',
 tableName: 'test',
 ...
 final idx = IndexMetrics(name: 'idx',
 tableName: 'tbl',
 sizeBytes: 1024 * 512,
 isUnique: true,
);
 ...
 final stats = GrowthStatistics(startTime: DateTime(2025, 6, 1),
 ...
 final alert = MonitoringAlert(severity: AlertSeverity.warning,
 ...
 totalSizeBytes: 10 * 1024 * 1024,
 tableMetrics: {
 'contacts': TableMetrics(name: 'contacts',
 rowCount: 50,
 sizeBytes: 50 * 1024,
 unusedBytes: 1024,
 ...
 'chats': TableMetrics(name: 'chats',
 rowCount: 20,
 sizeBytes: 20 * 1024,
 unusedBytes: 512,
 fragmentationRatio: 0.025,
),
 'archived_chats': TableMetrics(name: 'archived_chats',
 rowCount: 5,
 sizeBytes: 5 * 1024,
 unusedBytes: 256,
 ...
 indexMetrics: {
 'idx_messages_chat_id': IndexMetrics(name: 'idx_messages_chat_id',
 tableName: 'messages',
 sizeBytes: 100 * 1024,
 isUnique: false,
),
 'idx_contacts_pk': IndexMetrics(name: 'idx_contacts_pk',
 tableName: 'contacts',
 sizeBytes: 10 * 1024,
 isUnique: true,
),
 ...
 final m = TableMetrics(name: 'fragmented',
 rowCount: 0,
 sizeBytes: 10000,
 unusedBytes: 10000,
 ...
 final m = TableMetrics(name: 'compact',
 rowCount: 500,
 sizeBytes: 50000,
 unusedBytes: 0,
 fragmentationRatio: 0.0,
