// DatabaseQueryOptimizer supplementary coverage
...
void main() {
 ...
 setUpAll(() async {
 await TestSetup.initializeTestEnvironment(dbLabel: 'db_query_optimizer_p12',
);
 });
 ...
 final stats = QueryStatistics(query: 'SELECT 1',
 executionCount: 0,
 totalDurationMs: 0,
 minDurationMs: 0,
 maxDurationMs: 0,
 ...
 final stats = QueryStatistics(query: 'SELECT * FROM contacts WHERE id = 42',
 executionCount: 3,
 totalDurationMs: 90,
 minDurationMs: 20,
 maxDurationMs: 50,
 ...
 await DatabaseQueryOptimizer.instance.addToBatch(type: 'insert',
 ...
 await DatabaseQueryOptimizer.instance.addToBatch(type: 'update',
 table: 'app_preferences',
 ...
 await DatabaseQueryOptimizer.instance.addToBatch(type: 'delete',
 table: 'app_preferences',
 where: '"key" = ?',
 ...
 final result =
 await DatabaseQueryOptimizer.instance.executeTransaction<int>(operation: (txn) async {
 return 42;
 },
);
 ...
 expect(() => DatabaseQueryOptimizer.instance.executeTransaction<int>(operation: (txn) async {
 ...
 await DatabaseQueryOptimizer.instance.executeRead(sql: 'SELECT 1',
);
 ...
 await DatabaseQueryOptimizer.instance.executeQuery(operation: () async => null,
 description: 'a query',
);
 ...
 final hasAnalyzeLog = logRecords.any((r) => r.message.contains('ANALYZE completed'),
);
 ...
 final result = await DatabaseQueryOptimizer.instance.executeRead(sql: 'SELECT COUNT(*) as cnt FROM app_preferences',
);
 ...
 await DatabaseQueryOptimizer.instance.executeWrite(sql:
