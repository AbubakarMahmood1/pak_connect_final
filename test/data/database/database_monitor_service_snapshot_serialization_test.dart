/// Supplementary tests for DatabaseMonitorService
...
void main() {
 ...
 indexMetrics: {
 'idx_msg_ts': IndexMetrics(name: 'idx_msg_ts',
 tableName: 'messages',
 sizeBytes: 8192,
 isUnique: false,
),
 ...
 final original = TableMetrics(name: 'contacts',
 rowCount: 42,
 sizeBytes: 100000,
 unusedBytes: 5000,
 ...
 final idx = IndexMetrics(name: 'idx_1',
 tableName: 'messages',
 sizeBytes: 1024 * 1024,
 isUnique: true,
);
 ...
 final original = IndexMetrics(name: 'idx_pk',
 tableName: 'contacts',
 sizeBytes: 8192,
 isUnique: true,
);
 ...
 final snapshots = await DatabaseMonitorService.getHistoricalSnapshots(since: DateTime(2025, 1, 1),
);
 expect(snapshots, isEmpty);
 });

 test('respects limit filter', () async {
 final snapshots = await DatabaseMonitorService.getHistoricalSnapshots(limit: 5,
);
