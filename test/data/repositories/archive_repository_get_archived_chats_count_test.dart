...
void main() {
 ...
 setUpAll(() async {
 await TestSetup.initializeTestEnvironment(dbLabel: 'archive_repository_phase12',
);
 ...
 await createArchiveDirectly('ch_l2',
 'Large',
 10,
 ...
 await createArchiveDirectly('ch_l3',
 'Large',
 10,
 estimatedSize: 2000000,
);
 ...
 await createArchiveDirectly('ch_c',
 'Compressed',
 5,
 isCompressed: true,
);
 ...
 final filter = ArchiveSearchFilter(sortBy: ArchiveSortOption.contactName,
);
 final results = await repo.getArchivedChats(filter: filter);
 ...
 final filter = ArchiveSearchFilter(sortBy: ArchiveSortOption.dateOriginal,
);
 final results = await repo.getArchivedChats(filter: filter);
 ...
 final filter = ArchiveSearchFilter(sortBy: ArchiveSortOption.relevance,
);
 final results = await repo.getArchivedChats(filter: filter);
 ...
 await createArchiveDirectly('ch_cf1',
 'Alice Big',
 10,
 estimatedSize: 2000000,
);
 await createArchiveDirectly('ch_cf2',
 'Alice Small',
 1,
 estimatedSize: 100,
);
 await createArchiveDirectly('ch_cf3',
 'Bob Big',
 10,
 estimatedSize: 2000000,
);
