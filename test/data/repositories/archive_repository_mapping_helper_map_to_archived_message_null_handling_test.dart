...
void main() {
 ...
 Future<ArchiveId> insertArchiveRow(String chatId,
 String contactName, {
 int messageCount = 1,
 int? lastMessageTime,
 int? estimatedSize,
 ...
 Future<void> insertMessageRow(ArchiveId archiveId,
 String msgId,
 String chatId, {
 ...
 await insertMessageRow(archiveId,
 'msg3',
 'chat3',
 isStarred: 1,
 isForwarded: 1,
 ...
 expect(msg.archiveMetadata.preservationLevel,
 ArchivePreservationLevel.complete,
);
 expect(msg.archiveMetadata.indexingStatus,
 ...
 final archiveId = await insertArchiveRow('chatM1',
 'Xavier',
 metadataJson: null,
 ...
 final archiveId = await insertArchiveRow('chatM2',
 'Yolanda',
 metadataJson: meta,
);
 ...
 final archiveId = await insertArchiveRow('chatM3',
 'Zach',
 metadataJson: null,
 archiveReason: null,
);
 ...
 final archiveId = await insertArchiveRow('chatM4',
 'Amy',
 ...
 final archiveId = await insertArchiveRow('chatM6',
 'Carl',
 ...
 final archiveId = await insertArchiveRow('chatM7',
 'Dana',
 contactPublicKey: '',
);
 ...
 return ArchivedMessage(id: MessageId(id),
 ...
 archiveMetadata: const ArchiveMessageMetadata(archiveVersion: '1.0',
 ...
 const filter = ArchiveMessageTypeFilter(isFromMe: true,
