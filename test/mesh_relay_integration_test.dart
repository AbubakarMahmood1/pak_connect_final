...
void main() {
  group('Mesh Relay Integration Tests', () {
    test('ProtocolMessage enum extensions work correctly', () {
      ...
      expect(ProtocolMessageType.values.contains(ProtocolMessageType.meshRelay), true);
      expect(ProtocolMessageType.values.contains(ProtocolMessageType.queueSync), true);
      expect(ProtocolMessageType.values.contains(ProtocolMessageType.relayAck), true);
      ...
      expect(deserializedMessage.meshRelayFinalRecipient, 'recipient-public-key');
    });
    ...
    test('QueuedMessage backward compatibility', () {
      ...
      expect(json.containsKey('relayMetadata'), false); // Should not be included if null
    ...
    test('End-to-end relay flow simulation', () {
      ...
      final receivedMetadata = RelayMetadata.fromJson(received.meshRelayMetadata!);
