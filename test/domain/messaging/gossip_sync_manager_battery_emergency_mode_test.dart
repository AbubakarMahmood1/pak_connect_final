...
/// Supplementary tests for GossipSyncManager
...
void main() {
 ...
 manager = GossipSyncManager(myNodeId: testNodeId,
 ...
 MeshRelayMessage createMessage(String msgId,
 String sender,
 String recipient, {
 int hopCount = 1,
 }) {
 final metadata = RelayMetadata(ttl: 5,
 hopCount: hopCount,
 routingPath: [sender],
 ...
 manager.trackPublicMessage(messageId: 'msg_bat',
 message: msg,
 ...
 manager.trackPublicMessage(messageId: 'msg_charge',
 message: msg,
 messageType: MessageType.announce,
);
 ...
 manager.trackPublicMessage(messageId: 'msg_recover',
 message: msg,
 messageType: MessageType.announce,
);
 ...
 manager.trackPublicMessage(messageId: 'direct_1',
 message: msg,
 messageType: MessageType.announce,
);
 ...
 manager.trackPublicMessage(messageId: 'direct_2',
 message: msg2,
 messageType: MessageType.announce,
);
 ...
 manager.trackPublicMessage(messageId: 'multi_hop',
 message: msg,
 messageType: MessageType.announce,
);
 ...
 manager.trackPublicMessage(messageId: 'msg_$i',
 message: msg,
 messageType: MessageType.announce,
);
 }
 ...
 manager.trackPublicMessage(messageId: 'stat_msg',
 message: msg,
 messageType: MessageType.announce,
);
...
class MockOfflineMessageQueue extends Fake
 ...
 @override
 QueueStatistics getStatistics() => QueueStatistics(totalQueued: 0,
 totalDelivered: 0,
 totalFailed: 0,
 pendingMessages: 0,
 sendingMessages: 0,
 ...
 QueueSyncMessage.createRequest(messageIds: [],
 nodeId: nodeId,
 queueHash: _mockHash,
);
}
