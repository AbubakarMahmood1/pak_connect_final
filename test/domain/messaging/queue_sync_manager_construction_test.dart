...
void main() {
  ...
  group('handleSyncRequest', () {
    test('returns alreadySynced when queues match', () async {
      ...
      expect(response.responseMessage?.syncId, 'round-1');
    });
  ...
  group('QueueSyncResult factories', () {
    ...
    test('alreadySynced', () {
      expect(
        QueueSyncResult.alreadySynced().type,
  ...
  group('QueueSyncResponse factories', () {
    ...
    test('alreadySynced', () {
      expect(
        QueueSyncResponse.alreadySynced().type,
    ...
    test('rateLimited', () {
      expect(
        QueueSyncResponse.rateLimited('x').type,
