/// QueueSyncManager tests: construction, getStats,
...
class _FakeQueue extends Fake implements OfflineMessageQueueContract {
 ...
 @override
 QueueStatistics getStatistics() => QueueStatistics(totalQueued: 5,
 totalDelivered: 3,
 totalFailed: 1,
 pendingMessages: 2,
 sendingMessages: 0,
 ...
 @override
 QueueSyncMessage createSyncMessage(String nodeId) => QueueSyncMessage(queueHash: _hash,
...
QueuedMessage _qm(String id) => QueuedMessage(id: id,
 chatId: 'chat-1',
 content: 'test',
...
void main() {
 ...
 await manager.initialize(onSyncRequest: (_, _) {},
 onSendMessages: (_, _) {},
 onSyncCompleted: (_, _) {},
 onSyncFailed: (_, _) {},
);
 ...
 final msg = QueueSyncMessage(queueHash: 'hash-abc',
 ...
 await manager.initialize(onSendMessages: (msgs, nodeId) => sendCalls.add((msgs, nodeId)),
);

 final msg = QueueSyncMessage(queueHash: 'hash-other',
 messageIds: const ['msg-1'],
 syncTimestamp: DateTime(2024, 1, 1),
 nodeId: 'other-node',
 syncType: QueueSyncType.request,
 ...
 final responseMsg = QueueSyncMessage(queueHash: 'hash-resp',
 messageIds: const [],
 syncTimestamp: DateTime(2024, 1, 1),
 nodeId: 'other-node',
 ...
 test('success', () {
 final r = QueueSyncResult.success(messagesReceived: 5,
 messagesUpdated: 2,
 messagesSkipped: 1,
 finalHash: 'h1',
 ...
 final r = QueueSyncResult.success(messagesReceived: 1,
 messagesUpdated: 0,
 messagesSkipped: 0,
 finalHash: 'h',
 ...
 test('success', () {
 final msg = QueueSyncMessage(queueHash: 'h',
 messageIds: const [],
 syncTimestamp: DateTime(2024),
 nodeId: 'n',
 syncType: QueueSyncType.response,
);
 final r = QueueSyncResponse.success(responseMessage: msg,
 missingMessages: ['m1'],
 ...
 test('toString', () {
 const stats = QueueSyncManagerStats(totalSyncRequests: 100,
 successfulSyncs: 90,
 failedSyncs: 10,
