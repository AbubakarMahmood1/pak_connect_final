/// QueueSyncManager additional coverage:
...
class _FakeQueue extends Fake implements OfflineMessageQueueContract {
 ...
 return QueueSyncMessage(queueHash: hash,
...
class _ThrowingQueue extends Fake implements OfflineMessageQueueContract {
 ...
 @override
 QueueSyncMessage createSyncMessage(String nodeId) => QueueSyncMessage(queueHash: 'h',
 messageIds: const [],
...
void main() {
 ...
 await manager.initialize(onSyncRequest: (msg, nodeId) {
 ...
 final responseMsg = QueueSyncMessage(queueHash: 'h',
 messageIds: const [],
 syncTimestamp: DateTime(2024),
 nodeId: 'target-2',
 ...
 final m = QueueSyncManager(messageQueue: throwingQueue,
 nodeId: 'err-node',
);
 await m.initialize();
 ...
 final msg = QueueSyncMessage(queueHash: 'h-other',
 messageIds: const ['x'],
 syncTimestamp: DateTime(2024),
 nodeId: 'other',
 syncType: QueueSyncType.request,
