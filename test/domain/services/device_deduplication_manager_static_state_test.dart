...
void main() {
 ...
 // First discovery
 DeviceDeduplicationManager.processDiscoveredDevice(DiscoveredEventArgs(p, -70, _emptyAd()),
);
 expect(DeviceDeduplicationManager.getDevice(deviceId)?.rssi, -70);

 // Re-discovery with stronger RSSI
 DeviceDeduplicationManager.processDiscoveredDevice(DiscoveredEventArgs(p, -40, _emptyAd()),
);
 ...
 final contact = EnhancedContact(contact: Contact(publicKey: 'test-pk',
 displayName: 'Alice',
 ...
 final contact = EnhancedContact(contact: Contact(publicKey: 'pk',
 displayName: 'Bob',
 trustStatus: TrustStatus.newContact,
 securityLevel: SecurityLevel.low,
 firstSeen: DateTime.now(),
 ...
 EnhancedContact(contact: Contact(publicKey: 'pk-150',
 displayName: 'Peer150',
 trustStatus: TrustStatus.newContact,
 securityLevel: SecurityLevel.low,
 firstSeen: DateTime.now(),
 ...
 EnhancedContact(contact: Contact(publicKey: 'pk-160',
 displayName: 'Peer160',
 trustStatus: TrustStatus.newContact,
 securityLevel: SecurityLevel.low,
 firstSeen: DateTime.now(),
