...
import 'chat_management_service_static_config_test.mocks.dart';
...
void main() {
  ...
  setUp(() {
    ...
    service = ChatManagementService.withDependencies(
      chatsRepository: mockChats,
  ...
  group('ChatManagementService — static config', () {
    test('configureDependencyResolvers stores non-null resolvers', () {
      ChatManagementService.configureDependencyResolvers(
        chatsRepositoryResolver: () => mockChats,
    ...
    test('clearDependencyResolvers nullifies all resolvers', () {
      ...
      expect(
        () => ChatManagementService.fromServiceLocator(),
