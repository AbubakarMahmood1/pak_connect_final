/// Phase 12: Comprehensive tests for GroupMessagingService
///
...
void main() {
  ...
  group('sendGroupMessage', () {
    test('succeeds with all members contacted', () async {
      ...
      when(messageQueue.queueMessage(
      ...
      verify(messageQueue.queueMessage(
    ...
    test('handles member not in contacts (marks failed)', () async {
      ...
      await Future<void>.delayed(const Duration(milliseconds: 50));
      verify(groupRepo.updateDeliveryStatus(
        any,
        'ghost-member',
        MessageDeliveryStatus.failed,
      )).called(1);
      verifyNever(messageQueue.queueMessage(
        chatId: anyNamed('chatId'),
        content: anyNamed('content'),
