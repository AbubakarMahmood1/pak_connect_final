...
void main() {
 ...
 final emptyService = ContactManagementService.withDependencies(contactRepository: emptyRepo,
 messageRepository: messageRepo,
);
 ...
 await service.initialize();
 await service.updatePrivacySettings(const ContactPrivacySettings(allowAddressBookSync: true,
