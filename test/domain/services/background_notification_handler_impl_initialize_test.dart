...
class _FakeNotificationsPlugin extends Fake
 ...
 storedCallback?.call(NotificationResponse(notificationResponseType:
...
void main() {
 ...
 expect(logs.any((l) => l.message.contains('initialized successfully')),
 isTrue,
);
 });
 ...
 expect(logs.any((l) => l.message.contains('Already initialized')),
 isTrue,
);
 });
 ...
 await handler.showNotification(id: 'n1',
 title: 'Hello',
 body: 'World',
);
 ...
 await handler.showNotification(id: 'ch-${channel.name}',
 ...
 await handler.showNotification(id: 'pri-${priority.name}',
 ...
 await handler.showNotification(id: 'payload-test',
 title: 'T',
 body: 'B',
 ...
 await handler.showNotification(id: 'sound-vib',
 title: 'T',
 body: 'B',
 playSound: false,
 vibrate: false,
 ...
 final msg = app_entities.Message(id: const MessageId('msg-42'),
 ...
 handler.dispose();
 final msg = app_entities.Message(id: const MessageId('msg-43'),
 ...
 await handler.showContactRequestNotification(contactName: 'Carol',
 publicKey: 'pk-carol',
);
 ...
 await handler.showSystemNotification(title: 'System',
 message: 'Low alert',
 ...
 expect(logs.any((l) => l.message.contains('No payload')),
 isTrue,
);
 });
 ...
 final warnings = logs.where((l) => l.message.contains('Channel-specific cancellation'));
