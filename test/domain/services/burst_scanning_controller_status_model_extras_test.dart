/// BurstScanningController additional coverage
...
void main() {
 ...
 PowerManagementStats stats({PowerMode mode = PowerMode.balanced}) =>
 PowerManagementStats(currentScanInterval: 60000,
 ...
 final s = BurstScanningStatus(isBurstActive: false,
 ...
 final s = BurstScanningStatus(isBurstActive: true,
 ...
 expect(BurstScanningStatus(isBurstActive: false,
 currentScanInterval: 60000,
 powerStats: stats(mode: PowerMode.ultraLowPower),
).efficiencyRating,
 'Excellent',
);
 expect(BurstScanningStatus(isBurstActive: false,
 currentScanInterval: 60000,
 powerStats: stats(mode: PowerMode.powerSaver),
).efficiencyRating,
 'Good',
);
 expect(BurstScanningStatus(isBurstActive: false,
 currentScanInterval: 60000,
 powerStats: stats(mode: PowerMode.balanced),
).efficiencyRating,
 'Fair',
);
 expect(BurstScanningStatus(isBurstActive: false,
 currentScanInterval: 60000,
 powerStats: stats(mode: PowerMode.performance),
).efficiencyRating,
 'Poor',
);
 });
 ...
 await controller.triggerManualScan(delay: const Duration(seconds: 2),
);
