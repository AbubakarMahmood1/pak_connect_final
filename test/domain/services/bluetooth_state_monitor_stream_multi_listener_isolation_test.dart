/// BluetoothStateMonitor additional coverage.
///
...
void main() {
 ...
 final info = BluetoothStateInfo(state: s,
 ...
 final msg = BluetoothStatusMessage.unauthorized('A very long permission request message for testing purposes',
);
