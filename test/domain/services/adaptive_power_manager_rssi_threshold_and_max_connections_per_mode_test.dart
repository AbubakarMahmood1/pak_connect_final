/// AdaptivePowerManager additional coverage:
...
void main() {
 ...
 for (int i = 0; i < 5; i++) {
 manager.reportConnectionFailure(reason: 'timeout',
 rssi: -95,
 attemptTime: 5000,
);
 }
 ...
 final stats = PowerManagementStats(currentScanInterval: 80000,
 ...
 final stats = PowerManagementStats(currentScanInterval: 20000,
 currentHealthCheckInterval: 30000,
 consecutiveSuccessfulChecks: 0,
 consecutiveFailedChecks: 0,
 ...
 final m = ConnectionQualityMeasurement(timestamp: DateTime(2024),
 success: true,
 rssi: -55,
