/// Extended coverage for MeshQueueSyncCoordinator focusing on
...
class _FakeQueue extends Fake implements OfflineMessageQueueContract {
 ...
 @override
 QueueStatistics getStatistics() => QueueStatistics(totalQueued: _messages.length,
 totalDelivered: 0,
 ...
 final msg = QueuedMessage(id: 'queued-${_messages.length}',
 chatId: chatId,
 content: content,
...
class _FakeSyncManager extends Fake implements QueueSyncManagerContract {
 ...
 id: QueueSyncResult.success(messagesReceived: 0,
 messagesUpdated: 0,
 messagesSkipped: 0,
 finalHash: 'hash',
...
void main() {
 ...
 await coordinator.initialize(nodeId: 'node-1',
 messageQueue: queue,
 ...
 expect(() => coordinator.queueDirectMessage(chatId: 'c1',
 content: 'hi',
 ...
 expect(await coordinator.setPriority('msg-1', MessagePriority.high),
 isFalse,
);
 });
 ...
 final id = await coordinator.queueDirectMessage(chatId: 'chat-1',
 content: 'hello world',
 ...
 await coordinator.queueDirectMessage(chatId: 'chat-A',
 content: 'msg A',
 recipientPublicKey: 'rpk',
 senderPublicKey: 'spk',
);
 await coordinator.queueDirectMessage(chatId: 'chat-B',
 content: 'msg B',
 recipientPublicKey: 'rpk',
 senderPublicKey: 'spk',
);
 ...
 await coordinator.queueDirectMessage(chatId: 'chat-1',
 content: 'active',
 recipientPublicKey: 'rpk',
 senderPublicKey: 'spk',
);
 ...
 expect(() => coordinator.completeAck('no-such-id', success: true),
 returnsNormally,
);
 });
 });
