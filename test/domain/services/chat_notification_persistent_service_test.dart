// ChatNotificationService + PersistentChatStateManager supplementary
...
void main() {
 ...
 service.emitMessageUpdate(MessageUpdateEvent.starred(const MessageId('msg1')),
);
 await Future<void>.delayed(Duration.zero);
 ...
 service.emitMessageUpdate(MessageUpdateEvent.unstarred(const MessageId('msg1')),
);
 await sub.cancel();
 });
 ...
 service.emitMessageUpdate(MessageUpdateEvent.deleted(const MessageId('msg1'),
 const ChatId('chat1'),
),
);
 ...
 service.emitChatUpdate(ChatUpdateEvent.unarchived(const ChatId('chat1')),
);
 await Future<void>.delayed(Duration.zero);
 ...
 MessageUpdateEvent.deleted(const MessageId('m3'),
 const ChatId('c1'),
),
];
