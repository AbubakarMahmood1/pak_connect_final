// archive_search_models.dart coverage
...
void main() {
 ...
 final original = const SearchServiceConfig(enableFuzzySearch: false,
 maxCacheSize: 50,
 ...
 const opts = SearchOptions(fuzzySearch: true,
 ...
 final asr = AdvancedSearchResult.error(query: 'fail',
 ...
 final asr = AdvancedSearchResult(searchResult: sr,
 query: 'q',
 ...
 const q = ParsedSearchQuery(originalQuery: 'hello -world "exact phrase"',
 tokens: ['hello'],
 ...
 final entry = ArchiveSearchEntry(query: 'test',
 resultCount: 42,
 ...
 final original = ArchiveSearchEntry(query: 'round trip',
 resultCount: 10,
 ...
 final saved = SavedSearch(id: 'ss1',
 name: 'My Search',
 query: 'test query',
 createdAt: ts,
);
 ...
 final original = SavedSearch(id: 'ss3',
 name: 'Temporal',
 query: 'hello',
 ...
 final ts = DateTime(2025, 5, 1);
 final saved = SavedSearch(id: 'ss5',
 name: 'NoOpts',
 query: 'q',
 createdAt: ts,
);
 ...
 final s = SearchAnalyticsSummary(query: 'test',
 resultCount: 42,
 ...
 final result = AdvancedSearchResult.error(query: 'q',
 error: 'err',
 searchTime: Duration.zero,
);
 ...
 final cache = SearchResultCache(result: result,
 ...
 final cache = SearchSuggestionCache(suggestions: [SearchSuggestion.refinement('r')],
 cachedAt: DateTime.now(),
);
