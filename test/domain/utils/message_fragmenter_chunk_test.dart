...
void main() {
 ...
 final chunk = MessageChunk(messageId: 'abcdef123456',
 chunkIndex: 0,
 totalChunks: 3,
 content: 'hello',
 ...
 expect(() => MessageChunk.fromBytes(Uint8List.fromList(raw)),
 ...
 final chunk = MessageChunk(messageId: 'AB',
 chunkIndex: 0,
 totalChunks: 1,
 content: 'x',
 timestamp: DateTime.now(),
 ...
 final chunk = MessageChunk.withId(messageId: mid,
 chunkIndex: 0,
 totalChunks: 1,
 content: 'body',
 timestamp: DateTime.now(),
 ...
 final chunk = MessageChunk(messageId: 'id',
 chunkIndex: 0,
 totalChunks: 3,
 content: 'Hi there',
 timestamp: DateTime.now(),
 ...
 final original = MessageChunk(messageId: 'roundtrip1234',
 chunkIndex: 2,
 totalChunks: 4,
 ...
 final chunk = MessageChunk(messageId: 'abcdef',
 chunkIndex: 0,
 totalChunks: 1,
 content: 'bin',
 timestamp: DateTime.now(),
 ...
 expect(() => MessageFragmenter.fragment('hello', 24),
 ...
 expect(() => MessageFragmenter.fragmentBytes(data, 25, 'id1234'),
 throwsA(isA<Exception>()),
);
 });
 ...
 final chunk = MessageChunk(messageId: 'msg1',
 chunkIndex: 0,
 totalChunks: 3,
 content: 'part1',
 timestamp: DateTime.now(),
 ...
 final c0 = MessageChunk(messageId: 'msg2',
 chunkIndex: 0,
 totalChunks: 2,
 content: 'Hello ',
 timestamp: DateTime.now(),
);
 final c1 = MessageChunk(messageId: 'msg2',
 chunkIndex: 1,
 totalChunks: 2,
 content: 'World',
 timestamp: DateTime.now(),
 ...
 final c0 = MessageChunk(messageId: 'binMsg',
 chunkIndex: 0,
 totalChunks: 2,
 content: part1,
 timestamp: DateTime.now(),
 ...
 final c1 = MessageChunk(messageId: 'binMsg',
 chunkIndex: 1,
 totalChunks: 2,
 content: part2,
 timestamp: DateTime.now(),
 ...
 final c0 = MessageChunk(messageId: 'txtMsg',
 chunkIndex: 0,
 totalChunks: 2,
 content: 'foo',
 timestamp: DateTime.now(),
 ...
 final c1 = MessageChunk(messageId: 'txtMsg',
 chunkIndex: 1,
 totalChunks: 2,
 content: 'bar',
 timestamp: DateTime.now(),
 ...
 final chunk = MessageChunk(messageId: 'single',
 chunkIndex: 0,
 totalChunks: 1,
 content: 'only-one',
 timestamp: DateTime.now(),
 ...
 final c0 = MessageChunk(messageId: 'gap',
 chunkIndex: 0,
 totalChunks: 3,
 content: 'a',
 timestamp: DateTime.now(),
);
 final c2 = MessageChunk(messageId: 'gap',
 chunkIndex: 2,
 totalChunks: 3,
 content: 'c',
 timestamp: DateTime.now(),
 ...
 final chunk = MessageChunk(messageId: 'old-msg',
 chunkIndex: 0,
 totalChunks: 2,
 content: 'stale',
 timestamp: DateTime.now(),
 ...
 final c1 = MessageChunk(messageId: 'old-msg',
 chunkIndex: 1,
 totalChunks: 2,
 content: 'data',
 timestamp: DateTime.now(),
 ...
 final chunk = MessageChunk(messageId: 'recent-msg',
 chunkIndex: 0,
 totalChunks: 2,
 content: 'fresh',
 timestamp: DateTime.now(),
 ...
 final c1 = MessageChunk(messageId: 'recent-msg',
 chunkIndex: 1,
 totalChunks: 2,
 content: 'data',
 timestamp: DateTime.now(),
 ...
 test('full round-trip: fragmentBytes → addChunkBytes produces original bytes',
 () {
 ...
 final c0 = MessageChunk(messageId: 'ooo',
 chunkIndex: 0,
 totalChunks: 3,
 content: 'A',
 timestamp: DateTime.now(),
);
 final c1 = MessageChunk(messageId: 'ooo',
 chunkIndex: 1,
 totalChunks: 3,
 content: 'B',
 timestamp: DateTime.now(),
);
 final c2 = MessageChunk(messageId: 'ooo',
 chunkIndex: 2,
 totalChunks: 3,
 content: 'C',
 timestamp: DateTime.now(),
 ...
 final a0 = MessageChunk(messageId: 'msgA',
 chunkIndex: 0,
 totalChunks: 2,
 content: 'A1',
 timestamp: DateTime.now(),
);
 final b0 = MessageChunk(messageId: 'msgB',
 chunkIndex: 0,
 totalChunks: 2,
 content: 'B1',
 timestamp: DateTime.now(),
);
 final a1 = MessageChunk(messageId: 'msgA',
 chunkIndex: 1,
 totalChunks: 2,
 content: 'A2',
 timestamp: DateTime.now(),
);
 final b1 = MessageChunk(messageId: 'msgB',
 chunkIndex: 1,
 totalChunks: 2,
 content: 'B2',
 timestamp: DateTime.now(),
