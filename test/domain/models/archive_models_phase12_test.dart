...
void main() {
  group('ArchiveSearchResult', () {
    ...
    test('hasResults is true when totalResults > 0', () {
      final result = ArchiveSearchResult(
        messages: [],
        chats: [],
        messagesByChat: {},
        query: 'q',
  ...
  group('ArchiveSearchFilter', () {
    ...
    test('toJson/fromJson round-trip preserves fields', () {
      final original = ArchiveSearchFilter(
        contactFilter: 'Bob',
        tags: ['important'],
        onlyCompressed: true,
  ...
  group('ArchiveDateRange', () {
    ...
    test('toJson/fromJson round-trip', () {
      final original = ArchiveDateRange(
  ...
  group('ArchiveMessageTypeFilter', () {
    test('toJson/fromJson round-trip with all fields', () {
      final original = ArchiveMessageTypeFilter(
        hasAttachments: true,
        wasStarred: false,
        wasEdited: true,
        isFromMe: false,
  ...
  group('ArchiveOperationResult', () {
    test('success() creates successful result', () {
      final result = ArchiveOperationResult.success(
        message: 'Archived OK',
    ...
    test('failure() creates failed result', () {
      ...
      final result = ArchiveOperationResult.failure(
  ...
  group('ArchivePerformanceStats', () {
    ...
    test('isPerformanceAcceptable is false when archive too slow', () {
      final perf = ArchivePerformanceStats(
        averageArchiveTime: const Duration(seconds: 5),
