...
void main() {
  ...
  group('STEP 4: Protocol Message Validation', () {
    ...
    test('persistentKeyExchange preserves long public keys', () {
      const longKey = 'very_long_persistent_public_key_with_lots_of_cryptographic_data_0123456789abcdef';
      ...
      expect(message.payload['persistentPublicKey']!.length, equals(longKey.length));
    });
  ...
  group('STEP 4: Message Type Ordering', () {
    test('persistentKeyExchange comes after pairing messages in protocol', () {
      ...
      final pairingRequestIndex = types.indexOf(ProtocolMessageType.pairingRequest);
      final pairingAcceptIndex = types.indexOf(ProtocolMessageType.pairingAccept);
      final pairingCodeIndex = types.indexOf(ProtocolMessageType.pairingCode);
      final pairingVerifyIndex = types.indexOf(ProtocolMessageType.pairingVerify);
      final keyExchangeIndex = types.indexOf(ProtocolMessageType.persistentKeyExchange);
