/// MeshNetworkingProvider additional coverage.
///
...
void main() {
 ...
 MeshNetworkStatistics(nodeId: 'node-b',
 ...
 final result = await controller.sendMeshMessage(content: 'urgent!',
 ...
 final controller = MeshNetworkingController(service);
 final result = await controller.sendMeshMessage(content: 'no rush',
 recipientPublicKey: 'key_abcdef0123456789',
 ...
 final controller = MeshNetworkingController(service);
 final result = await controller.sendMeshMessage(content: 'offline',
 recipientPublicKey: 'key_abcdef0123456789',
);
 ...
 final service = _FakeMeshService();
 service.stats = stats(isInitialized: true,
 spamPreventionActive: false,
 queueSyncActive: false,
);
 ...
 const h = MeshNetworkHealth(overallHealth: 1.0,
 relayEfficiency: 1.0,
 queueHealth: 1.0,
 spamBlockRate: 0.0,
 isHealthy: true,
 ...
 const h = MeshNetworkHealth(overallHealth: 0.69,
 relayEfficiency: 0,
 queueHealth: 0,
 spamBlockRate: 0,
 isHealthy: false,
 ...
 const h = MeshNetworkHealth(overallHealth: 0.0,
 relayEfficiency: 0,
 queueHealth: 0,
 spamBlockRate: 0,
 isHealthy: false,
 ...
 const h = MeshNetworkHealth(overallHealth: 0.5,
 relayEfficiency: 0,
 queueHealth: 0,
 spamBlockRate: 0,
 isHealthy: false,
 ...
 const h = MeshNetworkHealth(overallHealth: 0.3,
 relayEfficiency: 0,
 queueHealth: 0,
 spamBlockRate: 0,
 isHealthy: false,
 ...
 final status = makeStatus(nodeId: 'my-node',
 isInitialized: true,
 isConnected: true,
 queueStats: const QueueStatistics(totalQueued: 100,
 totalDelivered: 80,
 totalFailed: 5,
 pendingMessages: 15,
 sendingMessages: 0,
 ...
 const relay = RelayStatistics(totalRelayed: 50,
 totalDropped: 2,
 ...
 final state = MeshNetworkingUIState(networkStatus: AsyncValue.data(status),
 ...
 final status = makeStatus(queueStats: const QueueStatistics(totalQueued: 100,
 totalDelivered: 95,
 totalFailed: 2,
 pendingMessages: 3,
 sendingMessages: 0,
 ...
 final inbox = BinaryPayloadInbox();
 inbox.addPayload(ReceivedBinaryEvent(transferId: 'tx-1',
 fragmentId: 'f1',
 originalType: 1,
 filePath: '/tmp/1.bin',
 size: 100,
 ...
 inbox.addPayload(ReceivedBinaryEvent(transferId: 'tx-2',
 fragmentId: 'f2',
 originalType: 2,
 filePath: '/tmp/2.bin',
 size: 200,
 ...
 final inbox = BinaryPayloadInbox();
 inbox.addPayload(ReceivedBinaryEvent(transferId: 'tx-a',
 fragmentId: 'f1',
 originalType: 1,
 filePath: '/tmp/a.bin',
 size: 10,
 ...
 inbox.addPayload(ReceivedBinaryEvent(transferId: 'tx-b',
 fragmentId: 'f2',
 originalType: 2,
 filePath: '/tmp/b.bin',
 size: 20,
 ...
 final inbox = BinaryPayloadInbox();
 inbox.addPayload(ReceivedBinaryEvent(transferId: 'tx-ow',
 fragmentId: 'f1',
 originalType: 1,
 ...
 final service = _FakeMeshService();
 service.stats = stats(relayStatistics: null,
 queueStatistics: const QueueStatistics(totalQueued: 10,
 totalDelivered: 10,
 totalFailed: 0,
 pendingMessages: 0,
 sendingMessages: 0,
...
class _FakeMeshService implements IMeshNetworkingService {
 MeshNetworkStatistics stats = const MeshNetworkStatistics(nodeId: 'fake-b',
 isInitialized: true,
 relayStatistics: null,
 queueStatistics: null,
 syncStatistics: null,
