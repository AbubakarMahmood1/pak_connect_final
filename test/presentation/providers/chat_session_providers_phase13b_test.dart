// Phase 13b: Extended coverage for chat_session_providers.dart
...
void main() {
  ...
  group('ChatSessionActions callbacks', () {
    ...
    test('handleMeshInitializationStatusChange with data', () {
      ...
      a.handleMeshInitializationStatusChange(
        null,
        const AsyncData(
          MeshNetworkStatus(
            isInitialized: true,
  ...
  group('chatSessionStateFromControllerProvider', () {
    test('is alias for chatSessionStateMirrorProvider', () {
      expect(
        chatSessionStateFromControllerProvider,
