// ChatSessionProviders data classes + model coverage
...
void main() {
 ...
 final actions = ChatSessionActions(sendMessage: (_) async {},
 ...
 String? captured;
 final actions = ChatSessionActions(sendMessage: (content) async { captured = content; },
 deleteMessage: (_, _) async {},
 retryFailedMessages: () async {},
 manualReconnection: () async {},
 retryFailedMessagesInline: () async {},
 ...
 actions.handleMeshInitializationStatusChange(null,
 const AsyncData(MeshNetworkStatus(isInitialized: true,
 isConnected: false,
 statistics: MeshNetworkStatistics(nodeId: 'test',
 isInitialized: true,
