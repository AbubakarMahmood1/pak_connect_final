...
/// Phase 13.2: Supplementary tests for mesh_networking_provider.dart
...
void main() {
  ...
  group('MeshNetworkingUIState — fallback values', () {
    test('error state returns safe defaults', () {
      final state = MeshNetworkingUIState(
        networkStatus: AsyncValue.error(Exception('boom'), StackTrace.current),
  ...
  group('MeshRuntimeState — copyWith queueStatistics', () {
    test('copyWith sets queueStatistics', () {
      ...
      const qStats = QueueSyncManagerStats(
