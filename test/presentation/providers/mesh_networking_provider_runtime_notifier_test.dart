...
class _FakeMeshService implements IMeshNetworkingService {
 ...
 MeshNetworkStatistics stats = const MeshNetworkStatistics(nodeId: 'node-test',
 isInitialized: true,
...
MeshNetworkStatus _status({
 ...
 MeshNetworkStatus(isInitialized: isInitialized,
 isConnected: isConnected,
 currentNodeId: currentNodeId,
 statistics: statistics ??
 const MeshNetworkStatistics(nodeId: 'test',
 isInitialized: true,
 spamPreventionActive: false,
 queueSyncActive: false,
),
...
const _defaultRelayStats = RelayStatistics(totalRelayed: 10,
 totalDropped: 1,
...
const _defaultQueueSyncStats = QueueSyncManagerStats(totalSyncRequests: 5,
 successfulSyncs: 4,
 failedSyncs: 1,
...
void main() {
 ...
 fakeService.statusCtrl.add(_status(isInitialized: true, isConnected: true, currentNodeId: 'abc'),
);
 fakeService.relayCtrl.add(_defaultRelayStats);
 fakeService.queueCtrl.add(_defaultQueueSyncStats);
 ...
 final event = ReceivedBinaryEvent(fragmentId: 'frag-2',
 originalType: 0x90,
 ...
 PendingBinaryTransfer(transferId: 'tx-3',
 recipientId: 'peer-1',
 originalType: 0x90,
),
];
 ...
 final inbox = BinaryPayloadInbox();
 for (var i = 0; i < 3; i++) {
 inbox.addPayload(ReceivedBinaryEvent(fragmentId: 'f-$i',
 originalType: 0x90,
 filePath: '/p$i',
 size: i * 10,
 transferId: 'tx-$i',
 ...
 final withStatus = base.copyWith(status: _status(isConnected: true, currentNodeId: 'n1'),
);
