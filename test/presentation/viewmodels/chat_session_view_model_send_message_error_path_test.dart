/// ChatSessionViewModel supplementary coverage.
///
...
void main() {
 ...
 await tester.pumpWidget(MaterialApp(home: Builder(builder: (context) {
 final scrollCtl = chat_controller.ChatScrollingController(chatsRepository: _FakeChatsRepo(),
 chatId: _cid('chat-1'),
 onScrollToBottom: () {},
 onUnreadCountChanged: (_) {},
 onStateChanged: () {},
 ...
 vm = ChatSessionViewModel(config: const ChatScreenConfig(chatId: 'chat-1',
 contactName: 'Alice',
),
