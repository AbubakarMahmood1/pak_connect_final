/// ChatSessionViewModel pure state transformer tests.
///
...
void main() {
 ...
 Future<ChatSessionViewModel> buildVM(WidgetTester tester, {
 ...
 final scrollCtl = chat_controller.ChatScrollingController(chatsRepository: chatsRepo,
 chatId: _cid('chat-1'),
 onScrollToBottom: () {},
 onUnreadCountChanged: (_) {},
 onStateChanged: () {},
);
 final searchCtl = ChatSearchController(onSearchModeToggled: (_) {},
 onSearchResultsChanged: (_, _) {},
 onNavigateToResult: (_) {},
 scrollController: scrollCtl.scrollController,
);

 viewModel = ChatSessionViewModel(config: const ChatScreenConfig(chatId: 'chat-1',
 contactName: 'Alice',
),
 ...
 final state = ChatUIState(messages: [_msg(id: 'm1', status: MessageStatus.sending)],
);
 final result =
 ...
 vm = await buildVM(tester);
 final state = ChatUIState(messages: [_msg(id: 'a'), _msg(id: 'b'), _msg(id: 'c')],
);
 ...
 vm = await buildVM(tester);
 final state = const ChatUIState(meshInitializing: false,
 initializationStatus: 'idle',
);
 final result = vm.applyMeshState(state,
 ...
 final scrollCtl = chat_controller.ChatScrollingController(chatsRepository: chats,
 chatId: _cid('chat-1'),
 onScrollToBottom: () {},
 onUnreadCountChanged: (_) {},
 onStateChanged: () {},
 ...
 final newScrollCtl = chat_controller.ChatScrollingController(chatsRepository: _FakeChatsRepo(),
 chatId: _cid('chat-2'),
 onScrollToBottom: () {},
 onUnreadCountChanged: (_) {},
 onStateChanged: () {},
);
 final newSearchCtl = ChatSearchController(scrollController: newScrollCtl.scrollController,
);
 final newMvm = _FakeMessagingVM();

 viewModel.rebindControllers(messagingViewModel: newMvm,
