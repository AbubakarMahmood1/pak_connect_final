/// Phase 13d: Additional HomeScreenController coverage
...
void main() {
  ...
  group('HomeScreenController – Phase 13d supplementary', () {
    ...
    testWidgets('handleDeviceSelected delays then reloads chats', (
      ...
      final future = ctrl.handleDeviceSelected(
        _DummyPeripheral(),
      );
    ...
    // -----------------------------------------------------------------------
    testWidgets('global message listener triggers chat update', (
      tester,
    ) async {
    ...
    // -----------------------------------------------------------------------
    testWidgets('unreadCountStream is set after initialize', (
      tester,
    ) async {
    ...
    // -----------------------------------------------------------------------
    testWidgets('showArchiveConfirmation delegates to facade', (
      tester,
    ) async {
    ...
    testWidgets('showDeleteConfirmation delegates to facade', (
      tester,
    ) async {
