...
class _MockChatsRepo implements IChatsRepository {
 ...
 return [
 ChatListItem(chatId: const ChatId('test-chat'),
 contactName: 'Test',
 ...
 @override
 dynamic noSuchMethod(Invocation invocation) => throw UnimplementedError('${invocation.memberName} not mocked',
);
}
...
void main() {
 ...
 controller = ChatScrollingController(chatsRepository: mockRepo,
 ...
 final messages = List.generate(5,
 (i) => Message(id: MessageId('msg$i'),
 chatId: const ChatId('test-chat'),
 content: 'test $i',
