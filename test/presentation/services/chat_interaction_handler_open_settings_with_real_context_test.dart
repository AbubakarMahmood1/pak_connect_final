/// ChatInteractionHandler: BuildContext-dependent code coverage
...
Future<BuildContext> _pumpCtx(WidgetTester tester) async {
 ...
 await tester.pumpWidget(ProviderScope(child: MaterialApp(home: Builder(builder: (c) {
 ctx = c;
...
void main() {
 ...
 final handler = ChatInteractionHandler(context: capturedCtx,
 ref: capturedRef,
 chatsRepository: repo,
);
