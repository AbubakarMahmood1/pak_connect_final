/// ChatInteractionHandler additional coverage
...
void main() {
 ...
 ChatInteractionHandler(chatsRepository: r ?? repo,
 ...
 final handler = make();
 final result = handler.formatTime(DateTime.now().subtract(const Duration(minutes: 15)),
);
 ...
 final handler = make();
 final result = handler.formatTime(DateTime.now().subtract(const Duration(hours: 3)),
);
 ...
 final handler = make();
 final result = handler.formatTime(DateTime.now().subtract(const Duration(days: 5)),
);
 ...
 final handler = make();
 final result = handler.formatTime(DateTime.now().subtract(const Duration(days: 1)),
);
 ...
 final handler = make();
 final result = handler.formatTime(DateTime.now().subtract(const Duration(hours: 1)),
);
 ...
 final handler = make();
 final result = handler.formatTime(DateTime.now().subtract(const Duration(minutes: 1)),
);
