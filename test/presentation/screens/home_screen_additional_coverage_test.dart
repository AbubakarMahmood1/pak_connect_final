    ...
    ProviderScope(
      overrides: [
        ...
        usernameProvider.overrideWith(
          () => usernameNotifier ?? _TestUsernameNotifier(username),
        ),
...
void main() {
  group('HomeScreen additional coverage', () {
    ...
    testWidgets('shows empty state icon and helper text', (tester) async {
      ...
      expect(
        find.text('Tap Bluetooth button below to scan/broadcast.'),
        findsOneWidget,
      );
    });

    testWidgets('loading indicator disappears once chats arrive', (
      tester,
    ) async {
    ...
    testWidgets('appBar shows username and tapping triggers edit', (
      tester,
    ) async {
      final repo = _FakeChatsRepository();
      final cms = _FakeChatManagementService();
    ...
    testWidgets('appBar shows PakConnect when username is empty', (
      tester,
    ) async {
      final repo = _FakeChatsRepository();
      final cms = _FakeChatManagementService();
    ...
    testWidgets('renders multiple chat tiles in list', (tester) async {
      final repo = _FakeChatsRepository()
        ..scriptedResponses.add([_chat('a'), _chat('b'), _chat('c')]);
      final cms = _FakeChatManagementService();
      final facade = _FakeHomeScreenFacade();
      final mesh = _FakeMeshNetworkingService();
    ...
    testWidgets('chat tile with connected status shows Active now', (
      tester,
    ) async {
      final repo = _FakeChatsRepository()
    ...
    testWidgets('tapping a chat tile calls openChat on facade', (tester) async {
      final repo = _FakeChatsRepository()
    ...
    testWidgets('swipe left-to-right shows archive background', (tester) async {
      final repo = _FakeChatsRepository()
    ...
    testWidgets('swipe right-to-left shows delete background', (tester) async {
      final repo = _FakeChatsRepository()
    ...
    testWidgets('long-press shows context menu with archive and delete', (
      tester,
    ) async {
      final repo = _FakeChatsRepository()
    ...
    testWidgets('context menu shows Pin Chat when not pinned', (tester) async {
      final repo = _FakeChatsRepository()
    ...
    testWidgets('context menu shows Mark as Read when unread > 0', (
      tester,
    ) async {
      final repo = _FakeChatsRepository()
    ...
    testWidgets('context menu shows Mark as Unread when unread == 0', (
      tester,
    ) async {
      final repo = _FakeChatsRepository()
    ...
    testWidgets('selecting Mark as Unread persists marker and reloads chats', (
      tester,
    ) async {
      final repo = _FakeChatsRepository()
        ..scriptedResponses.add([_chat('read-chat', unreadCount: 0)]);
      ...
      expect(repo.markedUnreadChats, [const ChatId('read-chat')]);
      expect(repo.seenSearchQueries.length, greaterThanOrEqualTo(2));
    });

    testWidgets('selecting Pin Chat from context menu calls toggleChatPin', (
      tester,
    ) async {
      final repo = _FakeChatsRepository()
    ...
    testWidgets(
      'selecting Archive Chat from context menu archives after confirmation',
      (tester) async {
        final repo = _FakeChatsRepository()
    ...
    testWidgets(
      'selecting Delete Chat from context menu deletes after confirmation',
      (tester) async {
        final repo = _FakeChatsRepository()
    ...
    testWidgets('selecting Mark as Read from context menu marks read', (
      tester,
    ) async {
      final repo = _FakeChatsRepository()
    ...
    testWidgets('search bar opens on search icon and filters by query', (
      tester,
    ) async {
      final repo = _FakeChatsRepository();
      final cms = _FakeChatManagementService();
    ...
    testWidgets('entering text in search bar passes query to repository', (
      tester,
    ) async {
      final repo = _FakeChatsRepository();
      final cms = _FakeChatManagementService();
    ...
    testWidgets('switching back to Chats tab shows FAB again', (tester) async {
      final repo = _FakeChatsRepository();
      final cms = _FakeChatManagementService();
      final facade = _FakeHomeScreenFacade();
      final mesh = _FakeMeshNetworkingService();
    ...
    testWidgets('Mesh Relay tab shows RelayQueueWidget content', (
      tester,
    ) async {
      final repo = _FakeChatsRepository();
      final cms = _FakeChatManagementService();
    ...
    testWidgets('FAB opens discovery overlay and close button dismisses it', (
      tester,
    ) async {
      final repo = _FakeChatsRepository();
      final cms = _FakeChatManagementService();
    ...
    testWidgets('unread badge shows count from unread stream', (tester) async {
      final repo = _FakeChatsRepository();
      final cms = _FakeChatManagementService();
      final facade = _FakeHomeScreenFacade();
      final mesh = _FakeMeshNetworkingService();
    ...
    testWidgets('RefreshIndicator wraps the chat list', (tester) async {
      final repo = _FakeChatsRepository()..scriptedResponses.add([_chat('r1')]);
      final cms = _FakeChatManagementService();
      final facade = _FakeHomeScreenFacade();
      final mesh = _FakeMeshNetworkingService();
    ...
    testWidgets('chat tile without last message omits subtitle text', (
      tester,
    ) async {
      final repo = _FakeChatsRepository()
    ...
    testWidgets(
      'archive from context menu does not archive when confirmation denied',
      (tester) async {
        final repo = _FakeChatsRepository()
    ...
    testWidgets(
      'delete from context menu does not delete when confirmation denied',
      (tester) async {
        final repo = _FakeChatsRepository()
    ...
    testWidgets('chat name is normal weight when unread count is 0', (
      tester,
    ) async {
      final repo = _FakeChatsRepository()
