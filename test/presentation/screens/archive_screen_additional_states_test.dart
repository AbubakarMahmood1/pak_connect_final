// archive_screen.dart additional coverage
...
ArchivedChatSummary _archive({
 ...
 return ArchivedChatSummary(id: ArchiveId(id),
...
AdvancedSearchResult _searchNoResults(String query) {
 return AdvancedSearchResult.error(query: query,
 error: 'no-results',
...
AdvancedSearchResult _searchWithMessage(String query) {
 final message = Message(id: MessageId('msg_archive_1'),
 ...
 final archivedMessage = ArchivedMessage.fromMessage(message,
 _now,
 customArchiveId: ArchiveId('archive_1'),
);
 final result = ArchiveSearchResult.fromResults(messages: <ArchivedMessage>[archivedMessage],
 ...
 return AdvancedSearchResult.fromSearchResult(searchResult: result,
 query: query,
 searchTime: const Duration(milliseconds: 18),
...
Future<void> _pumpArchiveScreen(WidgetTester tester, {
...
void main() {
 ...
 // -----------------------------------------------------------------------
 testWidgets('search mode with results renders result summary and tiles', (tester,
) async {
 final uiNotifier = _TestArchiveUINotifier(const ArchiveUIState(isSearchMode: true, searchQuery: 'hello'),
);
 final operationsNotifier = _TestArchiveOperationsNotifier(const ArchiveOperationsState(),
);

 await _pumpArchiveScreen(tester,
 ...
 // -----------------------------------------------------------------------
 testWidgets('toggle statistics hides then re-shows the card', (tester,
) async {
 final uiNotifier = _TestArchiveUINotifier(const ArchiveUIState());
 final operationsNotifier = _TestArchiveOperationsNotifier(const ArchiveOperationsState(),
);
 ...
 final uiNotifier = _TestArchiveUINotifier(const ArchiveUIState(isSearchMode: true, searchQuery: ''),
);
 final operationsNotifier = _TestArchiveOperationsNotifier(const ArchiveOperationsState(),
);
 ...
 // -----------------------------------------------------------------------
 testWidgets('clear search button in AppBar clears search state', (tester,
) async {
 final uiNotifier = _TestArchiveUINotifier(const ArchiveUIState(isSearchMode: true, searchQuery: 'xyz'),
);
 final operationsNotifier = _TestArchiveOperationsNotifier(const ArchiveOperationsState(),
);
 ...
 final uiNotifier = _TestArchiveUINotifier(const ArchiveUIState(isSearchMode: true, searchQuery: 'fail'),
);
 final operationsNotifier = _TestArchiveOperationsNotifier(const ArchiveOperationsState(),
);
 ...
 expect(find.textContaining('Archived chats will appear here'),
 findsOneWidget,
);
 });
 ...
 // -----------------------------------------------------------------------
 testWidgets('search mode renders search bar with hint text', (tester,
) async {
 final uiNotifier = _TestArchiveUINotifier(const ArchiveUIState(isSearchMode: true, searchQuery: ''),
);
 final operationsNotifier = _TestArchiveOperationsNotifier(const ArchiveOperationsState(),
 ...
 // -----------------------------------------------------------------------
 testWidgets('tapping search result tile opens search result dialog', (tester,
) async {
 final uiNotifier = _TestArchiveUINotifier(const ArchiveUIState(isSearchMode: true, searchQuery: 'hello'),
);
 final operationsNotifier = _TestArchiveOperationsNotifier(const ArchiveOperationsState(),
 ...
 // -----------------------------------------------------------------------
 testWidgets('statistics card is hidden when search mode is active', (tester,
) async {
 final uiNotifier = _TestArchiveUINotifier(const ArchiveUIState(isSearchMode: true, searchQuery: ''),
);
 final operationsNotifier = _TestArchiveOperationsNotifier(const ArchiveOperationsState(),
 ...
 final uiNotifier = _TestArchiveUINotifier(const ArchiveUIState());
 final operationsNotifier = _TestArchiveOperationsNotifier(const ArchiveOperationsState(isDeleting: true,
 ...
 // -----------------------------------------------------------------------
 testWidgets('operation indicator defaults to "Processing..."', (tester,
) async {
 final uiNotifier = _TestArchiveUINotifier(const ArchiveUIState());
 final operationsNotifier = _TestArchiveOperationsNotifier(const ArchiveOperationsState(isArchiving: true, currentOperation: null),
);
