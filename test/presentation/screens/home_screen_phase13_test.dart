...
void main() {
  group('HomeScreen Phase 13 — additional coverage', () {
    ...
    testWidgets('tapping a chat tile calls openChat on facade', (
      tester,
    ) async {
      final repo = _FakeChatsRepository()
    ...
    testWidgets('swipe left-to-right shows archive background', (
      tester,
    ) async {
      final repo = _FakeChatsRepository()
    ...
    testWidgets('swipe right-to-left shows delete background', (
      tester,
    ) async {
      final repo = _FakeChatsRepository()
    ...
    testWidgets('context menu shows Pin Chat when not pinned', (
      tester,
    ) async {
      final repo = _FakeChatsRepository()
    ...
    testWidgets('switching back to Chats tab shows FAB again', (
      tester,
    ) async {
      final repo = _FakeChatsRepository();
      final cms = _FakeChatManagementService();
    ...
    testWidgets('BLE banner shows when Bluetooth is unauthorized', (
      tester,
    ) async {
      final repo = _FakeChatsRepository();
      final cms = _FakeChatManagementService();
      ...
      expect(
        find.text('Bluetooth unauthorized - Allow Permission!'),
        findsOneWidget,
      );
    });
    ...
    testWidgets('unread badge shows count from unread stream', (
      tester,
    ) async {
      final repo = _FakeChatsRepository();
      final cms = _FakeChatManagementService();
