// ContactsScreen additional coverage
...
ContactSearchResult _result(List<EnhancedContact> contacts, {
 ...
 return ContactSearchResult(contacts: contacts,
 query: query,
...
Future<void> _pump(WidgetTester tester, {
 ...
 return const ContactStats(totalContacts: 0,
 verifiedContacts: 0,
 activeContacts: 0,
...
void main() {
 ...
 expect(find.widgetWithText(FloatingActionButton, 'Add Contact'),
 findsOneWidget,
);
 ...
 await _pump(tester,
 loadStats: () async => const ContactStats(totalContacts: 5,
 verifiedContacts: 3,
 activeContacts: 2,
 ...
 final contacts = [
 _contact(publicKey: 'pk_a_1234567890abcdef1234567890abcdef',
 displayName: 'Alice',
),
 _contact(publicKey: 'pk_b_1234567890abcdef1234567890abcdef',
 displayName: 'Bob',
),
 _contact(publicKey: 'pk_c_1234567890abcdef1234567890abcdef',
 displayName: 'Charlie',
),
];
 ...
 loadStats: () async => const ContactStats(totalContacts: 3,
 verifiedContacts: 0,
 activeContacts: 3,
 highSecurityContacts: 0,
),
 ...
 var loadCount = 0;
 final contacts = [
 _contact(publicKey: 'pk_r_1234567890abcdef1234567890abcdef',
 ...
 final contacts = [
 _contact(publicKey: 'pk_tap_1234567890abcdef1234567890abcde',
 ...
 _contact(publicKey: 'pk_s_1234567890abcdef1234567890abcdef',
 ...
 await _pump(tester,
 loadContacts: () async => _result([
 _contact(publicKey: 'pk_clr_234567890abcdef1234567890abcde',
 ...
 await _pump(tester,
 loadContacts: () async => _result([
 _contact(publicKey: 'pk_f1_234567890abcdef1234567890abcde',
 ...
 await _pump(tester,
 loadContacts: () async => _result([
 _contact(publicKey: 'pk_f2_234567890abcdef1234567890abcde',
 displayName: 'F2',
),
]),
);
 ...
 await _pump(tester,
 loadContacts: () async => _result([
 _contact(publicKey: 'pk_f3_234567890abcdef1234567890abcde',
 displayName: 'F3',
),
]),
);
 ...
 await _pump(tester,
 loadContacts: () async => _result([
 _contact(publicKey: 'pk_f4_234567890abcdef1234567890abcde',
 displayName: 'F4',
),
]),
);
 ...
 final chip = tester.widget<ChoiceChip>(find.widgetWithText(ChoiceChip, 'verified'),
);
 expect(chip.selected, isTrue);
 });
 ...
 await _pump(tester,
 loadContacts: () async => _result([
 _contact(publicKey: 'pk_f5_234567890abcdef1234567890abcde',
 displayName: 'F5',
),
]),
);
 ...
 await tester.tap(find.widgetWithText(SwitchListTile, 'Only Recently Active'),
);
 await tester.pumpAndSettle();

 final switchTile = tester.widget<SwitchListTile>(find.widgetWithText(SwitchListTile, 'Only Recently Active'),
);
 ...
 await _pump(tester,
 loadContacts: () async => _result([
 _contact(publicKey: 'pk_f6_234567890abcdef1234567890abcde',
 displayName: 'F6',
),
]),
);
 ...
 await _pump(tester,
 loadContacts: () async => _result([
 _contact(publicKey: 'pk_f7_234567890abcdef1234567890abcde',
 displayName: 'F7',
),
]),
);
 ...
 await _pump(tester,
 loadContacts: () async => _result([
 _contact(publicKey: 'pk_f8_234567890abcdef1234567890abcde',
 displayName: 'F8',
),
]),
);
 ...
 await _pump(tester,
 loadContacts: () async => _result([
 _contact(publicKey: 'pk_ch_234567890abcdef1234567890abcde',
 ...
 final securityChipDeleteIcon = find.descendant(of: find.widgetWithText(Chip, 'Security: high'),
 ...
 // Delete trust chip
 final trustChipDeleteIcon = find.descendant(of: find.widgetWithText(Chip, 'Trust: verified'),
 matching: find.byIcon(Icons.close),
);
 ...
 testWidgets('removing recently active chip keeps other filters (lines 262-272)',
 (tester) async {
 await applySecurityAndTrustFilter(tester);

 // Delete recently active chip
 final recentlyActiveDeleteIcon = find.descendant(of: find.widgetWithText(Chip, 'Recently Active'),
 matching: find.byIcon(Icons.close),
);
 ...
 await _pump(tester,
 loadContacts: () async => _result([
 _contact(publicKey: 'pk_so_234567890abcdef1234567890abcde',
 ...
 await _pump(tester,
 loadContacts: () async => _result([
 _contact(publicKey: 'pk_s2_234567890abcdef1234567890abcde',
 displayName: 'S2',
),
]),
);
 ...
 await _pump(tester,
 loadContacts: () async => _result([
 _contact(publicKey: 'pk_sl_234567890abcdef1234567890abcde',
 displayName: 'SL',
),
]),
);
 ...
 await _pump(tester,
 loadContacts: () async => _result([
 _contact(publicKey: 'pk_m1_234567890abcdef1234567890abcde',
 displayName: 'M1',
),
]),
);
 ...
 await _pump(tester,
 loadContacts: () async => _result([
 _contact(publicKey: 'pk_da_234567890abcdef1234567890abcde',
 displayName: 'DA',
),
]),
);
 ...
 await _pump(tester,
 loadContacts: () async => _result([
 _contact(publicKey: 'pk_se_234567890abcdef1234567890abcde',
 displayName: 'SE',
),
]),
);
 ...
 (tester) async {
 final contacts = [
 _contact(publicKey: 'pk_dt_234567890abcdef1234567890abcde',
 ...
 await _pump(tester,
 loadContacts: () async => _result([
 _contact(publicKey: 'pk_ca_234567890abcdef1234567890abcde',
 displayName: 'CA',
),
]),
);
