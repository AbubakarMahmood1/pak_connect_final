...
void main() {
 group('End-to-End Integration Flows', () {
 setUpAll(() async {
 await TestSetup.initializeTestEnvironment(dbLabel: 'phase3_integration_flows',
);
 });
 ...
 test('✅ All services can access repositories through IRepositoryProvider',
 () async {
 ...
 test('✅ Relay components use IRepositoryProvider and ISeenMessageStore abstractions',
 () async {
 ...
 test('✅ SeenMessageStore prevents duplicate message processing in relay flow',
 () async {
 // Arrange
 final seenStore = TestSetup.getService<ISeenMessageStore>();
 ...
 test('✅ Services access ContactRepository through IRepositoryProvider',
 () async {
 // Arrange
 final provider = TestSetup.getService<IRepositoryProvider>();
 ...
 test('✅ Services access MessageRepository through IRepositoryProvider',
 () async {
 // Arrange
 final provider = TestSetup.getService<IRepositoryProvider>();
 ...
 test('✅ Multiple services can access same IRepositoryProvider instance',
 () async {
 ...
 test('✅ NavigationService uses callback system instead of direct imports',
 () {
 // This verifies the refactoring in Task 3
 final navigationServiceFile = TestSetup.readProjectFile('lib/core/services/navigation_service.dart',
);

 // Assert - Should NOT have direct screen imports
 expect(navigationServiceFile.contains("import '../../presentation/screens/",
),
 isFalse,
 ...
 expect(navigationServiceFile.contains('typedef'),
 isTrue,
 ...
 test('✅ Domain layer abstractions (interfaces) do NOT import Data layer implementations',
 () {
 // Verify true dependency inversion
 final repositoryProviderInterfaceFile = TestSetup.readProjectFile('lib/domain/interfaces/i_repository_provider.dart',
);

 expect(repositoryProviderInterfaceFile.contains("import '../../data/repositories/",
),
 isFalse,
 reason:
 ...
 test('✅ IRepositoryProvider is available for services that need injection',
 () async {
 ...
 test('✅ Services coordinate through shared IRepositoryProvider instance',
 () async {
 ...
 test('✅ Services coordinate through shared ISeenMessageStore instance',
 () async {
 // Arrange
 ...
 test('✅ IRepositoryProvider is singleton across multiple resolutions',
 () async {
 ...
 test('✅ ISeenMessageStore is singleton across multiple resolutions',
 () async {
