/// OfflineMessageQueue maintenance helper coverage
...
void main() {
 ...
 fakeRepo._messages.add(_makeMessage(id: 'del-1',
 ...
 fakeRepo._messages.add(_makeMessage(id: 'stat-1', status: QueuedMessageStatus.pending),
);

 // markMessageDelivered triggers _updateStatistics
 fakeRepo._messages.add(_makeMessage(id: 'stat-2', status: QueuedMessageStatus.awaitingAck),
);
 ...
 fakeRepo._messages.add(_makeMessage(id: 'no-cb', status: QueuedMessageStatus.awaitingAck),
);
 ...
 fakeRepo._messages.add(_makeMessage(id: 'expired-direct',
 ...
 fakeRepo._messages.add(_makeMessage(id: 'expired-relay',
 status: QueuedMessageStatus.pending,
 isRelayMessage: true,
 expiresAt: DateTime.now().subtract(const Duration(hours: 1)),
),
 ...
 // Non-expired message
 fakeRepo._messages.add(_makeMessage(id: 'fresh',
 status: QueuedMessageStatus.pending,
 isRelayMessage: false,
 ...
 fakeRepo._messages.add(_makeMessage(id: 'recent-delivered',
 status: QueuedMessageStatus.delivered,
 ...
 fakeRepo._messages.add(_makeMessage(id: 'del-store', status: QueuedMessageStatus.awaitingAck),
);
 ...
 fakeScheduler.registerRetryTimer('msg-cancel-1',
 const Duration(seconds: 10),
 () {},
);

 // markMessageDelivered cancels retry timer
 fakeRepo._messages.add(_makeMessage(id: 'msg-cancel-1',
 ...
 fakeRepo._messages.add(_makeMessage(id: 'sent', status: QueuedMessageStatus.sending),
);
 ...
 fakeRepo._messages.add(_makeMessage(id: 'online-1', status: QueuedMessageStatus.pending),
);
 await queue.setOnline();
 // Should not throw
 });
 ...
 queue.setOffline();
 fakeRepo._messages.add(_makeMessage(id: 'requeue', status: QueuedMessageStatus.pending),
);
 await queue.setOnline();
 // Should not throw
 });
 ...
 fakeRepo._messages.addAll([
 _makeMessage(id: 'fail-1',
 status: QueuedMessageStatus.failed,
 attempts: 3,
),
 _makeMessage(id: 'fail-2',
 status: QueuedMessageStatus.failed,
 attempts: 5,
),
 ...
 fakeRepo._messages.add(_makeMessage(id: 'pending-only', status: QueuedMessageStatus.pending),
);

 await queue.retryFailedMessages();
 expect(queue.getMessageById('pending-only')?.status,
 ...
 fakeRepo._messages.addAll([
 _makeMessage(id: 'c1-fail',
 chatId: 'chat-A',
 status: QueuedMessageStatus.failed,
),
 _makeMessage(id: 'c2-fail',
 chatId: 'chat-B',
 status: QueuedMessageStatus.failed,
),
 _makeMessage(id: 'c1-ok',
 chatId: 'chat-A',
 status: QueuedMessageStatus.pending,
),
]);
 ...
 expect(queue.getMessageById('c1-fail')?.status,
 QueuedMessageStatus.pending,
);
 // chat-B failed message should remain failed
 expect(queue.getMessageById('c2-fail')?.status,
 QueuedMessageStatus.failed,
);
 });

 test('retryFailedMessagesForChat with no failed messages is no-op',
 () async {
 fakeRepo._messages.add(_makeMessage(id: 'fine',
 chatId: 'chat-X',
 status: QueuedMessageStatus.pending,
),
);
 ...
 fakeRepo._messages.add(_makeMessage(id: 'cp-1', priority: MessagePriority.normal),
);
 ...
 final result = await queue.changePriority('nonexistent',
 ...
 fakeRepo._messages.add(_makeMessage(id: 'same-p', priority: MessagePriority.high),
);
