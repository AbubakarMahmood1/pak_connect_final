// Tests for Role Awareness implementation
...
void main() {
 ...
 final unexpected = severe.where((l) => !allowedSevere.any((p) => p is String
 ...
 final found = severe.any((l) => pattern is String
 ...
 group('Relay Policy - Message Type Filtering', () {
 test('Handshake messages should NOT be relay-eligible', () {
 expect(RelayPolicy.isRelayEligibleMessageType(ProtocolMessageType.connectionReady,
),
 isFalse,
);
 expect(RelayPolicy.isRelayEligibleMessageType(ProtocolMessageType.identity),
 isFalse,
);
 expect(RelayPolicy.isRelayEligibleMessageType(ProtocolMessageType.noiseHandshake1,
),
 isFalse,
);
 expect(RelayPolicy.isRelayEligibleMessageType(ProtocolMessageType.noiseHandshake2,
),
 isFalse,
);
 expect(RelayPolicy.isRelayEligibleMessageType(ProtocolMessageType.noiseHandshake3,
),
 isFalse,
);
 });
 ...
 expect(RelayPolicy.isRelayEligibleMessageType(ProtocolMessageType.pairingRequest,
),
 isFalse,
);
 expect(RelayPolicy.isRelayEligibleMessageType(ProtocolMessageType.pairingAccept,
),
 isFalse,
);
 expect(RelayPolicy.isRelayEligibleMessageType(ProtocolMessageType.pairingCode),
 isFalse,
);
 expect(RelayPolicy.isRelayEligibleMessageType(ProtocolMessageType.pairingCancel,
),
 isFalse,
);
 expect(RelayPolicy.isRelayEligibleMessageType(ProtocolMessageType.contactRequest,
),
 isFalse,
);
 expect(RelayPolicy.isRelayEligibleMessageType(ProtocolMessageType.contactAccept,
),
 isFalse,
);
 expect(RelayPolicy.isRelayEligibleMessageType(ProtocolMessageType.contactReject,
),
 isFalse,
);
 });
 ...
 expect(RelayPolicy.isRelayEligibleMessageType(ProtocolMessageType.ping),
 isFalse,
);
 expect(RelayPolicy.isRelayEligibleMessageType(ProtocolMessageType.ack),
 isFalse,
);
 });

 test('Normal messages SHOULD be relay-eligible', () {
 expect(RelayPolicy.isRelayEligibleMessageType(ProtocolMessageType.textMessage),
 isTrue,
);
 expect(RelayPolicy.isRelayEligibleMessageType(ProtocolMessageType.meshRelay),
 isTrue,
);
 expect(RelayPolicy.isRelayEligibleMessageType(ProtocolMessageType.queueSync),
 isTrue,
);
 expect(RelayPolicy.isRelayEligibleMessageType(ProtocolMessageType.relayAck),
 isTrue,
);
 });
 ...
 group('Relay Policy - Message Validation', () {
 test('Should reject message with non-eligible type', () {
 final result = RelayPolicy.validateMessageForRelay(messageType: ProtocolMessageType.pairingRequest,
 recipientId: 'node123',
);
 ...
 final result = RelayPolicy.validateMessageForRelay(messageType: ProtocolMessageType.textMessage,
 recipientId: null,
);
 ...
 final result = RelayPolicy.validateMessageForRelay(messageType: ProtocolMessageType.meshRelay,
 recipientId: 'node123',
);
