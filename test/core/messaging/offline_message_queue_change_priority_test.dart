// OfflineMessageQueue + MaintenanceHelper coverage
...
void main() {
 ...
 test('changePriority returns true when priority is already the same',
 () async {
 ...
 await queue.initialize(onMessageDelivered: (msg) => deliveredMessages.add(msg),
);
 });
 ...
 fakeRepo._messages.add(_makeMessage(id: 'msg_deliver_1',
 ...
 fakeRepo._messages.add(_makeMessage(id: 'msg_d2', status: QueuedMessageStatus.retrying),
);
 ...
 await queue.initialize(onMessageFailed: (msg, reason) => failedReasons.add(reason),
);
 });
 ...
 final msg = _makeMessage(id: 'msg_fail_1',
 ...
 fakeRepo._messages.add(_makeMessage(id: 'f1', status: QueuedMessageStatus.failed, attempts: 3),
);
 fakeRepo._messages.add(_makeMessage(id: 'f2', status: QueuedMessageStatus.failed, attempts: 5),
);
 fakeRepo._messages.add(_makeMessage(id: 'p1', status: QueuedMessageStatus.pending),
);
 ...
 fakeRepo._messages.add(_makeMessage(id: 'f3', status: QueuedMessageStatus.failed),
);
 ...
 fakeRepo._messages.add(_makeMessage(id: 'fc1',
 chatId: 'chat_X',
 status: QueuedMessageStatus.failed,
),
);
 fakeRepo._messages.add(_makeMessage(id: 'fc2',
 chatId: 'chat_Y',
 status: QueuedMessageStatus.failed,
),
);
 ...
 test('flushQueueForPeer attempts delivery of pending peer messages',
 () async {
 fakeRepo._messages.add(_makeMessage(id: 'pm1', recipientPublicKey: 'peer_A'),
);
 fakeRepo._messages.add(_makeMessage(id: 'pm2', recipientPublicKey: 'peer_B'),
);
 ...
 fakeRepo._messages.add(_makeMessage(id: 'npm1',
 ...
 final healthy = QueueStatistics(totalQueued: 100,
 totalDelivered: 95,
 totalFailed: 5,
 pendingMessages: 0,
 sendingMessages: 0,
 ...
 final unhealthy = QueueStatistics(totalQueued: 100,
 totalDelivered: 10,
 totalFailed: 90,
 pendingMessages: 50,
 sendingMessages: 10,
 ...
 final stats = QueueStatistics(totalQueued: 5,
 totalDelivered: 3,
 totalFailed: 1,
 pendingMessages: 1,
 sendingMessages: 0,
