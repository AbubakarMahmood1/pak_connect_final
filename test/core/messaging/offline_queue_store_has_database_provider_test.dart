...
void main() {
 ...
 store.insertMessageByPriority(msg(id: 'u', priority: MessagePriority.urgent),
);
 store.insertMessageByPriority(msg(id: 'l', priority: MessagePriority.low),
);
 store.insertMessageByPriority(msg(id: 'h', priority: MessagePriority.high),
);
 ...
 store.insertMessageByPriority(msg(id: 'r1', isRelay: true, priority: MessagePriority.normal),
);
 ...
 store.insertMessageByPriority(msg(id: 'p1', status: QueuedMessageStatus.pending),
);
 store.insertMessageByPriority(msg(id: 's1', status: QueuedMessageStatus.sending),
);
 ...
 store.insertMessageByPriority(msg(id: 'p', status: QueuedMessageStatus.pending),
);
 store.insertMessageByPriority(msg(id: 'f', status: QueuedMessageStatus.failed),
);
 ...
 store.insertMessageByPriority(msg(id: 'done', status: QueuedMessageStatus.delivered),
);
 expect(store.repo.getOldestPendingMessage(), isNull);
 });
 ...
 expect(() => store.repo.queuedMessageFromDb({}),
 ...
 await store.persistenceManager.migrateQueueSchema(oldVersion: 1,
 newVersion: 2,
);
 });
