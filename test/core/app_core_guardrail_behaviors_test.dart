...
void main() {
 ...
 await expectLater(appCore.sendSecureMessage(chatId: 'chat-a',
 content: 'hello',
 ...
 final stats = AppStatistics(powerManagement: PowerManagementStats(currentScanInterval: 60000,
 ...
 messageQueue: const QueueStatistics(totalQueued: 20,
 totalDelivered: 18,
 totalFailed: 2,
 pendingMessages: 1,
 sendingMessages: 0,
 ...
 performance: const PerformanceMetrics(monitoringDuration: Duration(minutes: 5),
 totalOperations: 200,
 ...
 replayProtection: const ReplayProtectionStats(processedMessagesCount: 25,
 ...
 expect(stats.replayProtection.toString(),
