/// SecurityManager coverage targeting uncovered lines:
...
class _FakeRepo extends Fake implements IContactRepository {
 ...
 final c = byAnyId[pk];
 if (c != null) {
 byAnyId[pk] = _contact(key: c.publicKey,
...
void main() {
 ...
 repo.byAnyId['pk-eph'] = _contact(key: 'pk-eph',
 ...
 repo.byAnyId['pk-per'] = _contact(key: 'pk-per',
 trustStatus: TrustStatus.newContact,
 securityLevel: SecurityLevel.low,
 ...
 repo.byAnyId['ab'] = _contact(key: 'ab',
 trustStatus: TrustStatus.newContact,
 securityLevel: SecurityLevel.low,
);
 ...
 () async {
 repo.byAnyId['pk-pair-sync'] = _contact(key: 'pk-pair-sync',
 trustStatus: TrustStatus.newContact,
 securityLevel: SecurityLevel.low,
);
 ...
 repo.byAnyId['pk-mp'] = _contact(key: 'pk-mp',
 trustStatus: TrustStatus.newContact,
 securityLevel: SecurityLevel.low,
);
 ...
 repo.byAnyId['pk-he'] = _contact(key: 'pk-he',
 ...
 final enc = await sm.encryptMessageByType('test msg',
 'pk-rt',
 repo,
 EncryptionType.pairing,
);
 expect(enc, isNotEmpty);
 final dec = await sm.decryptMessageByType(enc,
 'pk-rt',
 repo,
 EncryptionType.pairing,
);
 ...
 repo.byAnyId['pk-ec'] = _contact(key: 'pk-ec',
 trustStatus: TrustStatus.verified,
 securityLevel: SecurityLevel.high,
);
 repo.secrets['pk-ec'] = 'cached-ecdh-secret';
 final enc = await sm.encryptMessageByType('hello ecdh',
 'pk-ec',
 repo,
 EncryptionType.ecdh,
);
 ...
 repo.byAnyId['pk-md'] = _contact(key: 'pk-md',
 trustStatus: TrustStatus.newContact,
 securityLevel: SecurityLevel.low,
);
 await SimpleCrypto.restoreConversationKey('pk-md', 'decrypt-key');
 // Encrypt with pairing
 final enc = await sm.encryptMessageByType('medium msg',
 'pk-md',
 repo,
 EncryptionType.pairing,
);
 ...
 repo.byAnyId['pk-hf'] = _contact(key: 'pk-hf',
 trustStatus: TrustStatus.verified,
 securityLevel: SecurityLevel.high,
);
 repo.secrets['pk-hf'] = 'ecdh-secret';
 // Encrypted with ecdh; try to decrypt garbage
 expect(() => sm.decryptMessage('garbage-data', 'pk-hf', repo),
 throwsA(isA<Exception>()),
);
 });

 test('LOW with unsupported legacy payload requests resync and fails closed',
 () async {
 repo.byAnyId['pk-lo'] = _contact(key: 'pk-lo',
 trustStatus: TrustStatus.newContact,
 securityLevel: SecurityLevel.low,
);
 await expectLater(() => sm.decryptMessage('PLAINTEXT:low level msg', 'pk-lo', repo),
 ...
 expect(() => sm.decryptMessage('bad-data', 'no-contact-pk', repo),
 throwsA(isA<Exception>()),
);
 });
 ...
 () async {
 repo.byAnyId['pk-re'] = _contact(key: 'pk-re',
 trustStatus: TrustStatus.newContact,
 securityLevel: SecurityLevel.low,
);
 ...
 final header = CryptoHeader(mode: CryptoMode.sealedV1,
 ephemeralPublicKey: base64.encode(List.filled(32, 0xAA)),
 nonce: base64.encode(List.filled(24, 0xBB)),
);
 expect(() => sm.decryptSealedMessage(encryptedMessage: base64.encode([1, 2, 3]),
 cryptoHeader: header,
 messageId: 'msg-1',
 ...
 repo.byAnyId['pk-bp'] = _contact(key: 'pk-bp',
 trustStatus: TrustStatus.newContact,
 securityLevel: SecurityLevel.low,
);
 ...
 repo.byAnyId['pk-be'] = _contact(key: 'pk-be',
 trustStatus: TrustStatus.verified,
 securityLevel: SecurityLevel.high,
);
 ...
 repo.byAnyId['pk-glob-bin'] = _contact(key: 'pk-glob-bin',
 trustStatus: TrustStatus.newContact,
 securityLevel: SecurityLevel.low,
);
 final data = Uint8List.fromList([1]);
 expect(() => sm.encryptBinaryPayload(data, 'pk-glob-bin', repo),
 ...
 repo.byAnyId['pk-bpd'] = _contact(key: 'pk-bpd',
 trustStatus: TrustStatus.newContact,
 securityLevel: SecurityLevel.low,
);
 ...
 repo.byAnyId['pk-bed'] = _contact(key: 'pk-bed',
 trustStatus: TrustStatus.verified,
 securityLevel: SecurityLevel.high,
);
 ...
 repo.byAnyId['pk-gbd'] = _contact(key: 'pk-gbd',
 trustStatus: TrustStatus.newContact,
 securityLevel: SecurityLevel.low,
);
 ...
 await expectLater(() => sm.decryptBinaryPayload(encryptedBytes, 'pk-gbd', repo),
 throwsA(isA<Exception>()),
);
 });
 });
 ...
 repo.byAnyId['pk-em'] = _contact(key: 'pk-em',
 trustStatus: TrustStatus.verified,
 securityLevel: SecurityLevel.high,
);
 ...
 await expectLater(() => sm.decryptMessageByType('legacy msg',
 'any-pk-1234567890',
 repo,
 ...
 repo.byAnyId['pk-ns'] = _contact(key: 'pk-ns',
 trustStatus: TrustStatus.newContact,
 securityLevel: SecurityLevel.low,
 ...
 repo.byAnyId['pk-nd'] = _contact(key: 'pk-nd',
 trustStatus: TrustStatus.newContact,
 securityLevel: SecurityLevel.low,
 persistentPublicKey: 'persistent-key-nd',
);
 expect(() => sm.decryptMessageByType(base64.encode([1, 2, 3]),
 'pk-nd',
 repo,
 ...
 repo.byAnyId['pk-map'] = _contact(key: 'pk-map',
 trustStatus: TrustStatus.newContact,
 securityLevel: SecurityLevel.low,
 ...
 expect(() => sm.encryptMessageByType('msg',
 'pk-map',
 repo,
 EncryptionType.noise,
),
 ...
 test('falls back to persistentPublicKey when ephemeral empty but persistent set',
 () async {
 repo.byAnyId['pk-fb'] = _contact(key: 'pk-fb',
 trustStatus: TrustStatus.newContact,
 securityLevel: SecurityLevel.low,
