/// SecurityManager additional coverage.
///
...
void main() {
 ...
 sm.registerIdentityMapping(persistentPublicKey: 'persistent-key',
 ephemeralID: 'eph-id',
);
 });
 ...
 () {
 sm.registerIdentityMappingForUser(persistentUserId: UserId('user-persistent'),
 ...
 repo.byAnyId['user-pk'] = _contact(key: 'user-pk',
 ...
 repo.byAnyId['user-em'] = _contact(key: 'user-em',
 trustStatus: TrustStatus.newContact,
 securityLevel: SecurityLevel.low,
);
 expect(() => sm.getEncryptionMethodForUser(UserId('user-em'), repo),
 ...
 repo.byAnyId['pk-high'] = _contact(key: 'pk-high',
 ...
 repo.byAnyId['pk-none'] = _contact(key: 'pk-none',
 trustStatus: TrustStatus.newContact,
 securityLevel: SecurityLevel.low,
);
 ...
 repo.byAnyId['pk-low-pat'] = _contact(key: 'pk-low-pat',
 trustStatus: TrustStatus.newContact,
 securityLevel: SecurityLevel.low,
);
 ...
 test('MEDIUM contact with valid 32-byte noisePublicKey returns KK',
 () async {
 final validKey = base64.encode(List.filled(32, 0xAA));
 repo.byAnyId['pk-kk'] = _contact(key: 'pk-kk',
 trustStatus: TrustStatus.newContact,
 ...
 test('MEDIUM contact with invalid base64 noisePublicKey falls back to XX',
 () async {
 repo.byAnyId['pk-inv'] = _contact(key: 'pk-inv',
 trustStatus: TrustStatus.newContact,
 securityLevel: SecurityLevel.medium,
 ...
 repo.byAnyId['pk-short'] = _contact(key: 'pk-short',
 trustStatus: TrustStatus.newContact,
 securityLevel: SecurityLevel.medium,
 ...
 repo.byAnyId['pk-null-nk'] = _contact(key: 'pk-null-nk',
 trustStatus: TrustStatus.newContact,
 securityLevel: SecurityLevel.medium,
 noisePublicKey: null,
);
 ...
 repo.byAnyId['pk-empty-nk'] = _contact(key: 'pk-empty-nk',
 trustStatus: TrustStatus.newContact,
 securityLevel: SecurityLevel.medium,
 noisePublicKey: '',
);
 ...
 final (pattern, key) = await sm.selectNoisePatternForUser(UserId('nonexistent'),
 repo,
);
 expect(pattern.name, 'xx');
 expect(key, isNull);
 ...
 expect(() => sm.encryptMessageByType('msg', 'pk', repo, EncryptionType.global),
 throwsA(isA<EncryptionException>()),
);
 });
 });
 ...
 expect(() => sm.decryptMessageByType('bad-data',
 'pk-ecdh-bad',
 repo,
 EncryptionType.ecdh,
),
 ...
 expect(() => sm.decryptSealedMessage(encryptedMessage: 'data',
 cryptoHeader: header,
 messageId: 'msg-1',
 ...
 repo.byAnyId['resolved-pk'] = _contact(key: 'resolved-pk',
 trustStatus: TrustStatus.newContact,
 securityLevel: SecurityLevel.low,
);
 ...
 repo.byAnyId['pk-low-g'] = _contact(key: 'pk-low-g',
 trustStatus: TrustStatus.newContact,
 securityLevel: SecurityLevel.low,
);
 expect(() => sm.getEncryptionMethod('pk-low-g', repo),
 throwsA(isA<EncryptionException>()),
);
 });
 });
 ...
 repo.byAnyId['pk-bin-g'] = _contact(key: 'pk-bin-g',
 trustStatus: TrustStatus.newContact,
 securityLevel: SecurityLevel.low,
);
 final data = Uint8List.fromList([1, 2, 3]);
 expect(() => sm.encryptBinaryPayload(data, 'pk-bin-g', repo),
 throwsA(isA<EncryptionException>()),
);
 });
 });
