/// PeerProtocolVersionGuard tests
...
void main() {
 ...
 PeerProtocolVersionGuard.trackObservedVersion(messageVersion: 3,
 peerKey: 'peer-A',
);
 expect(PeerProtocolVersionGuard.floorForPeer('peer-A'),
 ...
 expect(PeerProtocolVersionGuard.floorForPeer('unknown-peer'),
 lessThanOrEqualTo(1),
);
 });
 ...
 expect(PeerProtocolVersionGuard.floorForPeer('peer-B'),
 greaterThanOrEqualTo(2),
);
 });

 test('trackObservedVersion with v1 does not upgrade floor', () {
 PeerProtocolVersionGuard.trackObservedVersion(messageVersion: 1,
 peerKey: 'peer-C',
);
 expect(PeerProtocolVersionGuard.floorForPeer('peer-C'),
 lessThanOrEqualTo(1),
);
 });
 ...
 PeerProtocolVersionGuard.trackObservedVersion(messageVersion: 2,
 peerKey: 'peer-D',
);
 expect(PeerProtocolVersionGuard.floorForPeer('peer-D'),
 greaterThanOrEqualTo(2),
);
 });
 });
