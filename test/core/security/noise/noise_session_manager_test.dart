...
void main() {
  group('NoiseSessionManager', () {
    ...
    test(
      'preserves local static key across multiple session creations',
      () async {
        final aliceManager = NoiseSessionManager(
          localStaticPrivateKey: aliceStaticPrivate,
          localStaticPublicKey: aliceStaticPublic,
        ...
        final bobMsg2 = await bobManager.processHandshakeMessage(
          'Alice',
          bobMsg1,
        );
        final bobMsg3 = await aliceManager.processHandshakeMessage(
          'Bob',
          bobMsg2!,
        );
        ...
        expect(
          bobManager.getRemoteStaticKey('Alice'),
