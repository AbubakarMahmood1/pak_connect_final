...
void main() {
 ...
 await expectLater(appCore.initialize(),
 ...
 AppRuntimeServicesRegistry.publishBindings(AppRuntimeBindings(securityService: _FakeSecurityService(),
 ...
 messageQueue: const QueueStatistics(totalQueued: 10,
 totalDelivered: 9,
 totalFailed: 1,
 pendingMessages: 0,
 sendingMessages: 0,
 ...
 const stats = ReplayProtectionStats(processedMessagesCount: 100,
