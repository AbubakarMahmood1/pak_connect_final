...
class BatteryOptimizer {
  ...
  Future<void> initialize({
    ...
    try {
      ...
      _logger.info(
        '🔋 Battery Optimizer initialized - Level: $_currentLevel%, State: $_currentState',
      );
      ...
      _logger.info(
        '✅ Battery Optimizer running in ${_currentPowerMode.name} mode',
      );
    } catch (e) {
  ...
  void _applyPowerMode(BatteryPowerMode mode) {
    switch (mode) {
      ...
      case BatteryPowerMode.critical:
        _logger.severe(
          '🔋 🚨 Critical battery: Emergency power saving recommended',
        );
        break;
    }
  }
