  ...
  static Future<ExportResult> createExport({
    ...
    try {
      ...
      if (exportType == ExportType.full) {
        ...
        // Selective backup
        final selectiveBackup = await SelectiveBackupService.createSelectiveBackup(
      ...
      _logger.info('Database backup created: $backupPath ($recordCount records)');
      ...
      _logger.info('✅ Export complete (${exportType.name}): $bundlePath ($recordCount records, ${bundleSize / 1024}KB)');
