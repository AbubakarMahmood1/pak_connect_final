...
class ExportService {
  ...
  static Future<ExportResult> createExport({
    ...
    try {
      _logger.info('🔐 Starting export process...');
      ...
      _logger.info('Database backup created: ${dbBackup.backupPath}');
      ...
      _logger.info('✅ Export complete: $bundlePath (${bundleSize / 1024}KB)');
