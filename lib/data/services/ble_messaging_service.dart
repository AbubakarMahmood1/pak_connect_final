...
part 'ble_messaging_receive_helper.dart';
part 'ble_messaging_transport_helper.dart';
...
class BLEMessagingService implements IBLEMessagingService {
  ...
  late final _BleMessagingReceiveHelper _receiveHelper =
      _BleMessagingReceiveHelper(this);
  late final _BleMessagingTransportHelper _transportHelper =
      _BleMessagingTransportHelper(this);
  ...
  }) => _receiveHelper.resolveSenderNodeId(
    deviceId,
    providedNodeId: providedNodeId,
  );
  ...
  Future<void> _sendBinaryPayload({
    ...
    String? recipientId,
  }) => _transportHelper.sendBinaryPayload(
    data: data,
    originalType: originalType,
  ...
  }) => _transportHelper.forwardBinaryFragment(
    data: data,
    fragmentId: fragmentId,
  ...
  Future<void> _handleInboundTextMessage({
    ...
    String? messageId,
    String? senderNodeId,
  }) => _receiveHelper.handleInboundTextMessage(
    content: content,
    messageId: messageId,
    senderNodeId: senderNodeId,
  );
