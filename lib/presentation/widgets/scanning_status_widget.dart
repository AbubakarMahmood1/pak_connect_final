...
class ScanningStatusWidget extends ConsumerWidget {
  ...
  Widget _buildStatusIcon(BuildContext context, ThemeData theme, BurstScanningStatus burstStatus) {
    final isScanning = burstStatus.isBurstActive;
    final hasCountdown = burstStatus.secondsUntilNextScan != null &&
      ...
      child: Container(
        ...
        child: Stack(
          ...
          children: [
            ...
            if (hasCountdown && !isScanning && burstStatus.secondsUntilNextScan! <= 60)
              Positioned(
                bottom: -2,
                child: Container(
