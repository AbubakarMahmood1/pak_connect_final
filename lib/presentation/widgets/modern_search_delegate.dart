...
class ModernSearchDelegate extends SearchDelegate<String> {
  ...
  String get searchFieldLabel =>
      chatId != null ? 'Search in chat...' : 'Search messages...';
  ...
  Widget _buildSearchResults(
    ...
    chat_service.MessageSearchResult result,
  ) {
    final theme = Theme.of(context);
        ...
        Container(
          ...
          child: Row(
            children: [
              ...
              if (result.hasMore)
                Chip(
                  label: Text('More available', style: TextStyle(fontSize: 10)),
  ...
  Widget _buildGroupedResults(
    BuildContext context,
    Map<String, List<EnhancedMessage>> resultsByChat,
  ) {
    final theme = Theme.of(context);
  ...
  Widget _buildSearchTips(BuildContext context) {
    ...
    return ListView(
      padding: const EdgeInsets.all(16),
      children: [
        Text('Search Tips', style: theme.textTheme.titleLarge),
        const SizedBox(height: 16),
  ...
  Future<void> _showFilterDialog(BuildContext context) async {
    final result = await showModalBottomSheet<chat_service.MessageSearchFilter>(
      ...
      builder: (context) =>
          _SearchFilterBottomSheet(currentFilter: _currentFilter),
    );
            ...
            children: [
              ...
              Expanded(
                child: ListView(
                  ...
                  children: [
                    // Message source
                    Text('Message Source', style: theme.textTheme.titleMedium),
                    ...
                    // Special filters
                    Text('Special Filters', style: theme.textTheme.titleMedium),
                    ...
                    CheckboxListTile(
                      ...
                      onChanged: (value) =>
                          setState(() => _hasAttachments = value),
                    ),
