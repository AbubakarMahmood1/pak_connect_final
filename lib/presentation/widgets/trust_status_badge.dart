...
class TrustStatusBadge extends StatelessWidget {
  ...
  Widget _buildChip(BuildContext context, ThemeData theme, _TrustConfig config) {
    return Container(
  ...
  Widget _buildCompact(BuildContext context, ThemeData theme, _TrustConfig config) {
    return Row(
      mainAxisSize: MainAxisSize.min,
      children: [
        Icon(
