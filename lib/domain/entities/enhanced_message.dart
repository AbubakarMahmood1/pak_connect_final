...
class EnhancedMessage extends Message {
  ...
  bool get isDelivered => deliveryReceipt != null || status == MessageStatus.delivered;
  ...
  Duration? get timeSinceDelivery {
    ...
    return deliveryTime != null ? DateTime.now().difference(deliveryTime) : null;
  }
  ...
  EnhancedMessage copyWith({
    ...
    return EnhancedMessage(
      ...
      originalContent: editedContent != null ? (originalContent ?? content) : originalContent,
...
class MessageDeliveryReceipt {
  ...
  factory MessageDeliveryReceipt.fromJson(Map<String, dynamic> json) => MessageDeliveryReceipt(
...
class MessageReadReceipt {
  ...
  factory MessageReadReceipt.fromJson(Map<String, dynamic> json) => MessageReadReceipt(
...
class MessageEncryptionInfo {
  ...
  factory MessageEncryptionInfo.fromJson(Map<String, dynamic> json) => MessageEncryptionInfo(
